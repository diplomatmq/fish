    ...
    def _fill_default_data(self):
        ...
        with self._connect() as conn:
            ...
            fish_data = [
                ...
                # ===== ОЗЕРО (новые виды) =====
                ("Белуга", "Мифическая", 100.0, 500.0, 150, 450, 1100, "Озеро,Река", "Весна,Осень", "Сельдь,Кусочки рыбы,Живец,Крупный живец", 80, None),
                ...
                # ===== МОРЕ (новые виды) =====
                ("Тигровая акула", "Мифическая", 100.0, 700.0, 200, 550, 1500, "Море", "Лето,Осень", "Туша рыбы,Крупный кусок мяса,Спрут,Кальмар", 80, None),
                ("Акула-молот", "Мифическая", 80.0, 400.0, 150, 600, 1200, "Море", "Лето,Осень", "Крупный живец,Кальмар,Туша рыбы,Спрут", 80, None),
                ("Акула Мако", "Легендарная", 50.0, 300.0, 150, 400, 750, "Море", "Лето,Осень", "Сардина,Пилькер,Крупный живец,Кальмар", 65, None),
                ("Лисья акула", "Легендарная", 40.0, 250.0, 150, 500, 650, "Море", "Лето,Осень", "Живец,Кальмар,Блесна,Пилькер", 60, None),
                ...
                ("Морской чёрт", "Редкая", 5.0, 40.0, 40, 180, 300, "Море", "Все", "Кальмар,Живец,Кусочки рыбы,Крупный живец", 40, None),
                ...
                ("Морской петух", "Мифическая", 30.0, 180.0, 70, 230, 900, "Море", "Все", "Большой живец,Туша рыбы,Кальмар,Морской червь", 75, None),
                ...
                ("Морской черт", "Мифическая", 15.0, 100.0, 60, 200, 850, "Море", "Все", "Большой живец,Туша рыбы,Кальмар,Спрут,Кусок мяса", 75, None),
            ]
