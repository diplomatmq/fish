    ...
    def _fill_default_data(self):
        ...
        with self._connect() as conn:
            ...
            fish_data = [
                ...
                ("Коралл мозговидный", "Обычная", 0.01, 0.1, 20.0, 100.0, 10, "Коралловый риф", "Круглый Год", "Планктон", 6, None),
                ("Коралл ветвистый", "Обычная", 0.01, 0.1, 30.0, 150.0, 10, "Коралловый риф", "Круглый Год", "Планктон", 6, None),
