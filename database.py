    ...
    def _fill_default_data(self):
        ...
        with self._connect() as conn:
            ...
            fish_data = [
                ...
                ("Бестер (гибрид)", "Легендарная", 1.0, 8.0, 40, 100, 200, "Городской пруд", "Все", "Сельдь,Выползок,Кусочки рыбы,Кусок мяса,Живец", 20, None),
                ...
                ("Ленок", "Очень редкая", 0.5, 3.0, 30, 70, 90, "Река", "Все", "Мышь,Блесна,Мушка,Личинка короеда,Воблер", 14, None),
                ...
                ("Севрюга", "Очень редкая", 3.0, 25.0, 60, 180, 220, "Река", "Все", "Кусочки рыбы,Моллюск,Выползок,Кусок мяса", 40, None),
                ("Шип", "Очень редкая", 2.0, 12.0, 40, 120, 180, "Река", "Все", "Пучок червей,Моллюск,Личинка короеда,Черви", 30, None),
                ("Бычок-кругляк", "Обычная", 0.01, 0.08, 5, 12, 5, "Река", "Все", "Черви,Кусочки рыбы,Мотыль,Опарыш", 4, None),
                ("Верхогляд", "Очень редкая", 0.5, 3.0, 30, 70, 120, "Река", "Весна,Лето,Осень", "Живец,Воблер,Блесна,Кусочки рыбы", 18, None),
                ("Ауха", "Очень редкая", 0.5, 2.0, 25, 60, 110, "Река", "Лето,Осень", "Живец,Блесна,Воблер,Кусочки рыбы", 16, None),
                ("Калуга", "Легендарная", 20.0, 200.0, 100, 400, 600, "Река", "Все", "Крупный живец,Кусочки рыбы,Печень,Кусок мяса,Сельдь", 70, None),
                ...
                ("Голец арктический", "Очень редкая", 0.5, 3.0, 25, 60, 100, "Река", "Весна,Осень,Зима", "Икра,Блесна,Мормыш,Мушка", 14, None),
                ...
                ("Кумжа", "Очень редкая", 1.0, 7.0, 30, 80, 180, "Река", "Все", "Воблер,Блесна,Муха,Мушка,Живец", 18, None),
                ("Палия", "Очень редкая", 1.0, 8.0, 40, 90, 180, "Река", "Весна,Осень,Зима", "Блесна,Живец,Икра,Мотыль", 18, None),
                ...
                ("Мальма", "Редкая", 0.5, 3.0, 25, 65, 60, "Река", "Весна,Осень,Зима", "Блесна,Мусха,Живец,Икра,Мотыль", 12, None),
                ("Ишхан (Форель)", "Легендарная", 1.0, 8.0, 35, 80, 280, "Река", "Весна,Лето,Осень,Зима", "Блесна,Мушка,Живец,Икра,Воблер", 25, None),
                ...
                ("Валаамка (Сиг)", "Очень редкая", 0.5, 3.0, 25, 60, 130, "Река", "Осень,Зима", "Мормыш,Мотыль,Маленькая блесна,Икра", 18, None),
                ...
                # ===== ОЗЕРО (новые виды) =====
                ("Белуга (Монстр)", "Легендарная", 100.0, 500.0, 150, 450, 900, "Озеро", "Все", "Сельдь,Кусочки рыбы,Живец,Крупный живец", 70, None),
                ("Сом (Гигант)", "Очень редкая", 20.0, 150.0, 100, 350, 400, "Озеро", "Лето,Осень", "Выползок,Живец,Кусочки рыбы,Сельдь,Кусок мяса", 50, None),
                ("Калуга (Гигант)", "Легендарная", 50.0, 500.0, 150, 450, 700, "Озеро", "Все", "Живец,Кусочки рыбы,Выползок,Сельдь", 70, None),
                ("Лещ (Крупный)", "Редкая", 2.0, 7.0, 40, 70, 80, "Озеро", "Все", "Каша,Горох,Кукуруза,Мотыль,Пучок червей,Опарыш", 18, None),
                ("Судак (Хищник)", "Редкая", 2.0, 12.0, 40, 100, 90, "Озеро", "Все", "Воблер,Блесна,Живец,Узкая блесна,Кусочки рыбы", 20, None),
                ("Налим (Ночной)", "Редкая", 1.0, 8.0, 40, 100, 85, "Озеро", "Весна,Осень,Зима", "Кусочки рыбы,Живец,Выползок,Пучок червей", 18, None),
                ("Радужная форель", "Редкая", 0.5, 5.0, 30, 70, 80, "Озеро", "Все", "Икра,Муха,Воблер,Блесна,Живец,Мушка", 14, None),
                ("Плотва (Частая)", "Обычная", 0.05, 0.5, 10, 25, 8, "Озеро", "Все", "Тесто,Хлеб,Опарыш,Мотыль,Манка", 4, None),
                ...
                ("Уклейка (Мелочь)", "Обычная", 0.01, 0.03, 5, 10, 3, "Озеро", "Весна,Лето,Осень", "Муха,Опарыш,Хлеб,Манка", 3, None),
                ("Ёрш (Сорная)", "Обычная", 0.01, 0.05, 5, 12, 3, "Озеро", "Все", "Мотыль,Черви,Мормыш,Опарыш", 3, None),
                ("Толстолобик пестрый", "Очень редкая", 3.0, 15.0, 50, 120, 180, "Озеро", "Лето,Осень", "Огурец,Камыш,Каша,Тесто,Хлеб", 30, None),
                ("Арктический голец", "Очень редкая", 0.5, 3.0, 25, 60, 120, "Озеро", "Весна,Осень,Зима", "Икра,Блесна,Мормыш,Мотыль", 18, None),
                ("Омуль", "Редкая", 0.3, 2.0, 20, 55, 60, "Озеро", "Все", "Мормыш,Муха,Икра,Мотыль,Опарыш", 12, None),
                ("Нельма (Крупная)", "Легендарная", 5.0, 20.0, 60, 130, 320, "Озеро", "Весна,Осень,Зима", "Блесна,Воблер,Живец,Кусочки рыбы", 40, None),
                ("Веслонос (Редкая)", "Легендарная", 2.0, 10.0, 50, 120, 320, "Озеро", "Весна,Лето,Осень", "Каша,Тесто,Мотыль,Опарыш", 30, None),
                ("Кумжа", "Очень редкая", 1.0, 7.0, 30, 80, 170, "Озеро", "Все", "Воблер,Блесна,Муха,Мушка,Живец", 18, None),
                ("Палия", "Очень редкая", 1.0, 8.0, 40, 90, 170, "Озеро", "Весна,Осень,Зима", "Блесна,Живец,Икра,Мотыль", 18, None),
                ("Ряпушка (Мелочь)", "Обычная", 0.01, 0.05, 5, 12, 4, "Озеро", "Все", "Мотыль,Опарыш,Муха,Черви", 3, None),
                ...
                ("Колюшка (Крошечная)", "Обычная", 0.005, 0.02, 3, 7, 2, "Озеро", "Все", "Мотыль,Икра,Опарыш", 3, None),
                ...
                ("Бестер (Гибрид) (Крупный)", "Легендарная", 3.0, 15.0, 50, 130, 260, "Озеро", "Все", "Сельдь,Выползок,Кусочки рыбы,Живец,Кусок мяса", 35, None),
                ...
                # ===== МОРЕ (новые виды) =====
                ("Тигровая акула (Монстр)", "Легендарная", 100.0, 700.0, 200, 550, 1000, "Море", "Все", "Туша рыбы,Крупный кусок мяса,Спрут,Кальмар", 80, None),
                ("Акула-молот (Гигант)", "Легендарная", 80.0, 400.0, 150, 600, 900, "Море", "Все", "Крупный живец,Кальмар,Туша рыбы,Спрут", 80, None),
                ("Акула Мако", "Очень редкая", 50.0, 300.0, 150, 400, 600, "Море", "Все", "Сардина,Пилькер,Крупный живец,Кальмар", 60, None),
                ("Лисья акула", "Очень редкая", 40.0, 250.0, 150, 500, 550, "Море", "Все", "Живец,Кальмар,Блесна,Пилькер", 55, None),
                ("Парусник (Быстрая)", "Очень редкая", 15.0, 100.0, 100, 340, 500, "Море", "Весна,Лето,Осень", "Воблер,Пилькер,Сардина,Спрут,Кальмар", 50, None),
                ...
                ("Палтус синекорый (Дно)", "Очень редкая", 20.0, 200.0, 80, 250, 400, "Море", "Все", "Моллюск,Кусочки рыбы,Кальмар,Сельдь", 45, None),
                ("Скат-хвостокол", "Редкая", 5.0, 60.0, 40, 180, 160, "Море", "Все", "Морской червь,Моллюск,Кусочки рыбы,Кальмар", 25, None),
                ("Морской чёрт", "Очень редкая", 5.0, 40.0, 40, 180, 300, "Море", "Все", "Кальмар,Живец,Кусочки рыбы,Крупный живец", 40, None),
                ("Конгер (Морской угорь)", "Очень редкая", 5.0, 50.0, 80, 300, 320, "Море", "Все", "Крупный кусок мяса,Кальмар,Живец,Кусок мяса", 40, None),
                ("Луфарь", "Обычная", 1.0, 15.0, 30, 100, 35, "Море", "Весна,Лето,Осень", "Пилькер,Блесна,Сардина,Живец", 18, None),
                ("Лаврак (Сибас)", "Обычная", 1.0, 12.0, 30, 100, 40, "Море", "Все", "Креветка,Воблер,Морской червь,Блесна", 18, None),
                ("Зубан (Дентекс)", "Редкая", 2.0, 15.0, 40, 100, 120, "Море", "Все", "Кальмар,Живец,Пилькер,Кусочки рыбы", 25, None),
                ("Групер гигантский", "Легендарная", 50.0, 200.0, 100, 250, 700, "Море", "Все", "Крупный живец,Спрут,Кусок мяса,Кальмар", 70, None),
                ("Серриола (Амберджек)", "Редкая", 5.0, 80.0, 60, 190, 200, "Море", "Все", "Живец,Пилькер,Кальмар,Воблер", 30, None),
                ("Пеламида (Бонито)", "Обычная", 1.0, 10.0, 35, 90, 40, "Море", "Все", "Блесна,Сардина,Воблер,Живец,Пилькер", 18, None),
                ("Пилорыл (Редкая)", "Легендарная", 100.0, 400.0, 200, 700, 800, "Море", "Все", "Моллюск,Кусочки рыбы,Кальмар,Крупный кусок мяса", 80, None),
                ("Рыба-луна (Экзотика)", "Легендарная", 200.0, 1500.0, 100, 330, 1200, "Море", "Лето,Осень", "Спрут,Кальмар,Моллюск,Медуза", 80, None),
                ("Сагрина (Зеленушка)", "Обычная", 0.1, 0.5, 10, 25, 10, "Море", "Весна,Лето,Осень", "Креветка,Тесто,Мякиш хлеба,Морской червь", 5, None),
                ("Морской петух", "Редкая", 0.2, 2.0, 20, 50, 50, "Море", "Все", "Морской червь,Креветка,Блесна,Кусочки рыбы", 10, None),
                ("Скорпена (Ёрш)", "Редкая", 0.2, 2.0, 15, 40, 55, "Море", "Все", "Кусочки рыбы,Креветка,Живец,Морской червь", 12, None),
                ("Лихия", "Редкая", 3.0, 25.0, 40, 110, 150, "Море", "Весна,Лето,Осень", "Воблер,Живец,Сардина,Пилькер", 25, None),
                ("Сариола (Желтохвост)", "Редкая", 5.0, 40.0, 50, 150, 160, "Море", "Все", "Пилькер,Кальмар,Блесна,Живец", 25, None),
                ("Морской дракон", "Редкая", 0.1, 1.0, 10, 40, 55, "Море", "Все", "Морской червь,Опарыш,Креветка,Мотыль", 10, None),
                ("Анчоус (Мелочь)", "Обычная", 0.01, 0.03, 5, 10, 4, "Море", "Все", "Опарыш,Тесто,Мякиш хлеба,Морской червь", 3, None),
                ("Шпрот (Мелочь)", "Обычная", 0.01, 0.03, 5, 10, 4, "Море", "Все", "Мякиш хлеба,Тесто,Опарыш,Креветка", 3, None),
                ("Луна-рыба (Опах)", "Очень редкая", 30.0, 150.0, 60, 180, 400, "Море", "Все", "Кальмар,Спрут,Сардина,Живец", 50, None),
                ("Каменный окунь", "Редкая", 0.2, 3.0, 15, 50, 60, "Море", "Все", "Креветка,Морской червь,Сало,Кусочки рыбы", 12, None),
                ("Морская лисица", "Очень редкая", 5.0, 60.0, 40, 180, 350, "Море", "Все", "Кусочки рыбы,Сало,Моллюск,Кальмар", 45, None),
            ]
