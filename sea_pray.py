...
PRAY_INTRO_CAPTION = (
    "🌊 <b>Молитва вознесена…</b>\n\n"
    "Волны стихают. Из глубин поднимается <i>Повелитель Морей</i> — "
...
OUTCOME_MESSAGES: Dict[str, str] = {
    "wrath": (
        ...
        "шанс клёва снижен на <b>40%</b> на <b>6 часов</b>.\n\n"
        "<i>«Не зови меня понапрасну, смертный…»</i>"
    ),
    "blessing": (
        "✨ <b>Благословение Амфитриты</b>\n\n"
        "Морская королева коснулась вод вашей души. "
        "Шанс клёва повышен на <b>+35%</b> на <b>6 часов</b>.\n\n"
        "<i>«Иди, и пусть волны будут милостивы к тебе.»</i>"
    ),
    "gift_fish": (
        "🐉 <b>Дар Левиафана</b>\n\n"
