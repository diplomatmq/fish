(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=e(a);fetch(a.href,n)}})();class Et{constructor(){var t,e,s;this.tg=((t=window.Telegram)==null?void 0:t.WebApp)??null,this.tg&&(this.tg.ready(),this.tg.expand(),(s=(e=this.tg).disableVerticalSwipes)==null||s.call(e),this.tg.setHeaderColor("#0a1628"),this.tg.setBackgroundColor("#0a1628"))}haptic(t){var e;(e=this.tg)!=null&&e.HapticFeedback&&(t==="selection"?this.tg.HapticFeedback.selectionChanged():t==="success"||t==="error"?this.tg.HapticFeedback.notificationOccurred(t):t==="impact"?this.tg.HapticFeedback.impactOccurred("medium"):["light","medium","heavy"].includes(t)&&this.tg.HapticFeedback.impactOccurred(t))}getUserName(){var t,e,s;return((s=(e=(t=this.tg)==null?void 0:t.initDataUnsafe)==null?void 0:e.user)==null?void 0:s.first_name)??null}getUserTag(){var e,s,a;const t=(a=(s=(e=this.tg)==null?void 0:e.initDataUnsafe)==null?void 0:s.user)==null?void 0:a.username;return t?`@${t}`:null}getUser(){var e,s;const t=(s=(e=this.tg)==null?void 0:e.initDataUnsafe)==null?void 0:s.user;return!t||!t.id?null:{id:t.id,first_name:t.first_name,username:t.username}}showAlert(t){var e;(e=this.tg)!=null&&e.showAlert?this.tg.showAlert(t):alert(t)}}const o=new Et,ct={home:`
  ...
  `};function b(i,t=""){const e=ct[i]||ct.home;return t?e.replace("<svg",`<svg class="${t}"`):e}function Mt(){const i=document.getElementById("app");return i.innerHTML=`
...
`,"<br>")}</p>
  ...
  `,document.body.appendChild(i),i}function Tt(i,t=1600){setTimeout(()=>{i.style.transition="opacity 0.6s ease",i.style.opacity="0",setTimeout(()=>i.remove(),700)},t)}function qt(i,t){const e=document.getElementById("btn-achievements"),s=document.getElementById("btn-rating"),a=document.getElementById("btn-results");[e,s,a].forEach(n=>{n&&n.addEventListener("click",()=>{o.haptic("light"),n.classList.remove("bounce"),n.offsetWidth,n.classList.add("bounce"),n.addEventListener("animationend",()=>n.classList.remove("bounce"),{once:!0})})}),s&&i&&s.addEventListener("click",i),a&&t&&a.addEventListener("click",t)}function _t(i){const t=document.getElementById("select-trophy-btn");t&&(t.addEventListener("click",i),t.addEventListener("pointerdown",()=>{t.style.transform="scale(0.96)"}),t.addEventListener("pointerup",()=>{t.style.transform=""}),t.addEventListener("pointerleave",()=>{t.style.transform=""}))}const dt=[{id:"home",icon:"🧭",label:"ГЛАВНАЯ"},{id:"shop",icon:"🧺",label:"ЛАВКА"},{id:"friends",icon:"👤",label:"ДРУЗЬЯ"},{id:"guilds",icon:"🔱",label:"АРТЕЛИ"},{id:"book",icon:"📖",label:"КНИГА"}],I={name:"АКВАМАН_01",tag:"@aquaman01",level:15,xp:7200,maxXp:1e4,avatar:"🤿"},C={common:"#90e0ef",rare:"#00b4d8",legendary:"#f4a82e",aquarium:"#4cc9f0",mythical:"#ef476f",anomaly:"#7b2cbf"},It=()=>{var i,t;return((t=(i=window.Telegram)==null?void 0:i.WebApp)==null?void 0:t.initData)||""};async function u(i,t={}){const s={"Content-Type":"application/json","X-Telegram-Init-Data":It(),...t.headers||{}},a=await fetch(i,{...t,headers:s});if(!a.ok){const n=await a.json().catch(()=>({error:"Unknown error"}));throw new Error(n.error||`HTTP error! status: ${a.status}`)}return a.json()}const X=u;class At{constructor(){this.fillEl=null,this.wobbling=!1,this.profile={...I},this.el=this.build(),this.loadProfile()}async loadProfile(){try{const t=await u("/api/profile");t&&(this.profile.name=t.username||this.profile.name,this.profile.level=t.level||this.profile.level,this.profile.xp=t.xp||this.profile.xp,this.profile.maxXp=1e4,this.profile.tag=`@${t.user_id}`||this.profile.tag,this.updateUI())}catch(t){console.error("Failed to load profile:",t)}}updateUI(){const t=this.el.querySelector("#profile-name"),e=this.el.querySelector("#profile-tag"),s=this.el.querySelector(".level-label"),a=this.el.querySelector(".xp-label");t&&(t.textContent=this.profile.name.toUpperCase()),e&&(e.textContent=this.profile.tag),s&&(s.textContent=`Уровень ${this.profile.level}`),a&&(a.textContent=`${this.profile.xp.toLocaleString("ru")} XP`),this.animateProgress(0)}getElement(){return this.el}build(){const t=I,e=Math.round(t.xp/t.maxXp*100),s=document.createElement("div");s.id="profile-panel",s.className="profile-panel glass",s.innerHTML=`
    ...
    `,document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&document.body.removeChild(e)}),e.querySelectorAll(".sell-opt-btn").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.cat;o.haptic("light"),document.body.removeChild(e),a?this.sellBulk({category:a}):s.classList.contains("select-mode-btn")&&(this.mode="select",this.selectedIds.clear(),this.renderInventory())})})}async showFishDetailModal(t){var e,s,a;try{const n=await u("/api/inventory"),r=((n==null?void 0:n.items)||[]).filter(m=>t.ids.includes(m.id));if(r.length===0)return;const l=L(t.rarity),d=C[l]||"#ccc",c=document.createElement("div");c.className="modal-overlay is-open",c.style.display="flex";const p=`
      ...
      `;c.innerHTML=p,document.body.appendChild(c);let g=new Set,x=null;const h=c.querySelector("#fish-detail-content"),y=c.querySelector(".fish-action-buttons"),w=c.querySelector("#confirm-detail-btn");(e=c.querySelector("#make-trophy-btn"))==null||e.addEventListener("click",()=>{o.haptic("light"),x="trophy",y.style.display="none",h.style.display="block",w.style.display="block",w.textContent="СДЕЛАТЬ ТРОФЕЕМ"}),(s=c.querySelector("#select-to-sell-btn"))==null||s.addEventListener("click",()=>{o.haptic("light"),x="sell",y.style.display="none",h.style.display="block",w.style.display="block",w.textContent="ПРОДАТЬ"}),c.querySelectorAll(".fish-detail-card").forEach(m=>{m.addEventListener("click",()=>{o.haptic("light");const M=parseInt(m.dataset.id||"0");g.has(M)?(g.delete(M),m.classList.remove("selected")):(g.add(M),m.classList.add("selected"))})}),(a=c.querySelector("#cancel-detail-btn"))==null||a.addEventListener("click",()=>{o.haptic("light"),document.body.removeChild(c)}),w==null||w.addEventListener("click",async()=>{if(g.size===0){alert("Выберите хотя бы одну рыбу");return}o.haptic("medium"),document.body.removeChild(c),x==="trophy"?await this.makeTrophies(Array.from(g)):x==="sell"&&await this.sellBulk({ids:Array.from(g)})}),c.addEventListener("click",m=>{m.target===c&&document.body.removeChild(c)})}catch(n){console.error("Failed to load fish details:",n),alert("Ошибка загрузки деталей рыбы")}}async makeTrophies(t){try{let e=0,s=!1,a=0,n=0;for(const r of t){const l=await u("/api/make-trophy",{method:"POST",body:JSON.stringify({id:r})});if(l!=null&&l.ok)e++;else if((l==null?void 0:l.error)==="insufficient_coins"){s=!0,a=l.required||1e4,n=l.current||0;break}}s?alert(`Недостаточно монет!
Требуется: ${a} 🪙
...
Опыт: ${e.earned_xp} ✨`),this.mode="view",this.selectedIds.clear(),await this.loadInventory())}catch{alert("Ошибка при продаже")}}async loadInventory(){this.loading=!0;try{const t=await u("/api/inventory/grouped");this.items=(t==null?void 0:t.items)||[],this.renderInventory()}catch(t){console.error("Failed to load inventory:",t),this.renderError()}finally{this.loading=!1}}renderInventory(){const t=this.el.querySelector("#shop-content"),e=this.el.querySelector("#shop-sell-btn"),s=this.el.querySelector("#shop-select-actions");if(this.mode==="select"?(e.style.display="none",s.style.display="flex",this.updateSelectCount()):(e.style.display=this.items.length>0?"block":"none",s.style.display="none"),this.items.length===0){t.innerHTML=`
      ...
      <div class="inventory-grid">
        ${this.items.map((a,n)=>{const r=L(a.rarity),l=C[r]||"#ccc",d=a.ids.every(g=>this.selectedIds.has(g)),c=a.ids.some(g=>this.selectedIds.has(g))&&!d;let p="";return this.mode==="select"&&(d?p="is-selected":c&&(p="is-partial")),`
...
`)}`:"Не хватает ресурсов для улучшения.")}else i.reason==="max_level"?alert("Артель уже максимального уровня."):i.reason==="leader_only"||i.reason==="not_leader"?alert("Улучшать артель может только лидер."):alert(`Не удалось улучшить артель: ${i.reason||i.error||"неизвестная ошибка"}`)}catch(i){console.error("Failed to upgrade guild:",i)}return!1}async function oe(i){try{const t=await u("/api/guilds/members/remove",{method:"POST",body:JSON.stringify({member_id:i})});if(t&&t.ok)return await E(),!0;t&&!t.ok&&alert(`Не удалось удалить участника: ${t.reason||t.error||"неизвестная ошибка"}`)}catch(t){console.error("Failed to remove guild member:",t)}return!1}function Y(i,t,e){return{id:String(i.id),title:String(i.title||""),startsAt:String(i.starts_at||""),endsAt:String(i.ends_at||""),createdBy:String(i.created_by||""),createdAt:String(i.created_at||""),isActive:t===String(i.id),phase:e==="active"||e==="grace"?e:void 0}}async function ce(){try{const i=await u("/api/guilds/tournaments");if(i&&i.ok){const t=i.active_id?String(i.active_id):null,e=i.visible_id?String(i.visible_id):null,s=i.phase==="active"||i.phase==="grace"?i.phase:null,a=(i.items||[]).map(l=>Y(l,t)),n=i.active?Y(i.active,t,"active"):null,r=i.visible?Y(i.visible,e,s||void 0):null;return{items:a,activeId:t,active:n,visibleId:e,visible:r,phase:s}}}catch(i){console.error("Failed to load clan tournaments:",i)}return{items:[],activeId:null,active:null,visibleId:null,visible:null,phase:null}}async function de(i,t){try{const e=await u(`/api/guilds/tournaments/members?guild_id=${encodeURIComponent(i)}&tournament_id=${encodeURIComponent(t)}`);if(e&&e.ok)return Array.isArray(e.members)?e.members.map(P):[]}catch(e){console.error("Failed to load tournament members:",e)}return[]}async function he(i,t,e){try{const s=await u("/api/guilds/tournaments/create",{method:"POST",body:JSON.stringify({title:i,starts_at:t,ends_at:e})});if(s&&s.ok&&s.tournament){const a=s.tournament;return{id:String(a.id),title:String(a.title||""),startsAt:String(a.starts_at||""),endsAt:String(a.ends_at||""),createdBy:String(a.created_by||""),createdAt:String(a.created_at||""),isActive:!1}}}catch(s){console.error("Failed to create clan tournament:",s)}return null}async function ue(i){try{const t=await u(`/api/guilds/tournaments/leaderboard?tournament_id=${encodeURIComponent(i)}`);if(t&&t.ok)return(t.items||[]).map(e=>({clanId:String(e.clan_id??e.clanId??""),name:String(e.name||""),totalWeight:Number(e.total_weight||0),totalFish:Number(e.total_fish||0)}))}catch(t){console.error("Failed to load clan tournament leaderboard:",t)}return[]}class pe{constructor(){this.contentEl=null,this.toolbarEl=null,this.tab="list",this.loading=!1,this.newGuildName="",this.selectedAvatar=ht[0],this.selectedColor=ut[0],this.selectedType="open",this.selectedMinLevel=0,this.visibleTournament=null,this.tournamentPhase=null,this.tournamentLeaderboard=[],this.showAdminTournamentForm=!1,this.tournamentTitle="",this.tournamentStarts="",this.tournamentEnds="",this.clanModalGuildId=null,this.clanModalGuildName="",this.clanModalMembers=[],this.clanModalLoading=!1,this.clanModalTournament=!1,this.el=this.buildShell(),this.modalHost=document.createElement("div"),this.modalHost.id="guild-modals-root",this.modalHost.className="guild-modals-root",document.body.appendChild(this.modalHost),document.body.classList.remove("guild-modal-open")}getElement(){return this.el}closeModals(){this.clanModalGuildId=null,this.clanModalMembers=[],this.showAdminTournamentForm=!1,this.renderModals()}buildShell(){const t=document.createElement("section");return t.id="screen-guilds",t.className="screen guilds-screen",t.setAttribute("role","main"),t.innerHTML=`
    ...
    `}bindRating(){this.el.querySelectorAll('.guild-rating-card[data-tournament="0"]').forEach(t=>{t.addEventListener("click",async()=>{var n,r;const e=t.getAttribute("data-id");if(!e)return;const s=f.find(l=>l.id===e);this.clanModalGuildId=e,this.clanModalGuildName=(s==null?void 0:s.name)||"Артель",this.clanModalTournament=!1,this.clanModalLoading=!0,this.clanModalMembers=(n=s==null?void 0:s.members)!=null&&n.length?[...s.members]:[],this.renderModals();const a=await W(e);this.clanModalMembers=a.length?a:((r=f.find(l=>l.id===e))==null?void 0:r.members)||[],this.clanModalLoading=!1,this.renderModals()})})}renderTournamentContent(){const t=this.visibleTournament;if(!t)return'<div class="members-empty">Турнир недоступен.</div>';const e=this.tournamentPhase==="grace"?"Турнир завершён — итоги ещё сутки":"Идёт турнир",s=`${this.formatDate(t.startsAt)} → ${this.formatDate(t.endsAt)}`,a=this.tournamentLeaderboard.length?this.tournamentLeaderboard.map((n,r)=>`
    ...
    `}bindTournament(){this.el.querySelectorAll('[data-tournament="1"]').forEach(t=>{t.addEventListener("click",async()=>{const e=t.getAttribute("data-id");if(!e||!this.visibleTournament)return;const s=this.tournamentLeaderboard.find(a=>a.clanId===e);this.clanModalGuildId=e,this.clanModalGuildName=(s==null?void 0:s.name)||"Артель",this.clanModalTournament=!0,this.clanModalLoading=!0,this.clanModalMembers=[],this.renderModals(),this.clanModalMembers=await de(e,this.visibleTournament.id),this.clanModalLoading=!1,this.renderModals()})})}renderClanModalHtml(){const t=this.clanModalTournament?"Улов за турнир":"Улов в артели",e=this.clanModalLoading?'<div class="members-empty">Загрузка...</div>':this.clanModalMembers.length?[...this.clanModalMembers].sort((s,a)=>a.totalWeight-s.totalWeight).map((s,a)=>`
          ...
          `).join(""):`<div class="members-empty">${this.clanModalGuildId?"Не удалось загрузить участников.":"Нет участников."}</div>`;return`
      ...
      <div class="glass artel-form" style="padding: 20px;">
        ...
        <div class="form-group">
          ...
          <div class="avatar-grid">
            ${ht.map(l=>`<div class="avatar-opt ${this.selectedAvatar===l?"is-selected":""}" data-val="${l}">${b(l)}</div>`).join("")}
          </div>
        </div>
        <div class="form-group">
          <label class="form-label">Цвет</label>
          <div class="color-row">
            ${ut.map(l=>`<div class="color-opt ${this.selectedColor===l?"is-selected":""}" data-val="${l}" style="background:${l}"></div>`).join("")}
          </div>
        </div>
        <div class="form-group">
