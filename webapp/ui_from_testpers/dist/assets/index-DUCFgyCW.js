(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=e(a);fetch(a.href,n)}})();class xt{constructor(){var t;this.tg=((t=window.Telegram)==null?void 0:t.WebApp)??null,this.tg&&(this.tg.ready(),this.tg.expand(),this.tg.setHeaderColor("#0a1628"),this.tg.setBackgroundColor("#0a1628"))}haptic(t){var e;(e=this.tg)!=null&&e.HapticFeedback&&(t==="selection"?this.tg.HapticFeedback.selectionChanged():t==="success"||t==="error"?this.tg.HapticFeedback.notificationOccurred(t):t==="impact"?this.tg.HapticFeedback.impactOccurred("medium"):["light","medium","heavy"].includes(t)&&this.tg.HapticFeedback.impactOccurred(t))}getUserName(){var t,e,s;return((s=(e=(t=this.tg)==null?void 0:t.initDataUnsafe)==null?void 0:e.user)==null?void 0:s.first_name)??null}getUserTag(){var e,s,a;const t=(a=(s=(e=this.tg)==null?void 0:e.initDataUnsafe)==null?void 0:s.user)==null?void 0:a.username;return t?`@${t}`:null}getUser(){var e,s;const t=(s=(e=this.tg)==null?void 0:e.initDataUnsafe)==null?void 0:s.user;return!t||!t.id?null:{id:t.id,first_name:t.first_name,username:t.username}}showAlert(t){var e;(e=this.tg)!=null&&e.showAlert?this.tg.showAlert(t):alert(t)}}const o=new xt,ct={home:`
  ...
  `};function v(i,t=""){const e=ct[i]||ct.home;return t?e.replace("<svg",`<svg class="${t}"`):e}function Lt(){const i=document.getElementById("app");return i.innerHTML=`
    ...
    <div id="screens-wrap" class="screens-wrap">
      ...
      <section id="screen-shop" class="screen" role="main" aria-label="Лавка">
        ...
        <div class="glass shop-container">
          <div class="shop-empty">
            <div class="shop-soon-icon">${v("shop")}</div>
      ...
      <!-- BOOK -->
      ${Et("book","📖","Книга рыбака",`Здесь появится ваш
рыболовный журнал`)}
  ...
  `,i}function Et(i,t,e,s){return`
    <section id="screen-${i}" class="screen screen--empty" role="main" aria-label="${e}">
      ...
      <div class="glass empty-content">
        <div class="empty-icon" aria-hidden="true">${v(i)}</div>
        <p class="empty-text">${s.replace(`
`,"<br>")}</p>
      </div>
    </section>
  `}function Mt(){const i=document.createElement("div");return i.id="entry-overlay",i.className="entry-overlay",i.innerHTML=`
    <div class="entry-logo" aria-hidden="true">🌊</div>
    <p class="entry-title">ПОДВОДНЫЙ МИР</p>
    <p class="entry-subtitle">Загрузка…</p>
  `,document.body.appendChild(i),i}function Ct(i,t=1600){setTimeout(()=>{i.style.transition="opacity 0.6s ease",i.style.opacity="0",setTimeout(()=>i.remove(),700)},t)}function Tt(i,t){const e=document.getElementById("btn-achievements"),s=document.getElementById("btn-rating"),a=document.getElementById("btn-results");[e,s,a].forEach(n=>{n&&n.addEventListener("click",()=>{o.haptic("light"),n.classList.remove("bounce"),n.offsetWidth,n.classList.add("bounce"),n.addEventListener("animationend",()=>n.classList.remove("bounce"),{once:!0})})}),s&&i&&s.addEventListener("click",i),a&&t&&a.addEventListener("click",t)}function qt(i){const t=document.getElementById("select-trophy-btn");t&&(t.addEventListener("click",i),t.addEventListener("pointerdown",()=>{t.style.transform="scale(0.96)"}),t.addEventListener("pointerup",()=>{t.style.transform=""}),t.addEventListener("pointerleave",()=>{t.style.transform=""}))}const dt=[{id:"home",icon:"🧭",label:"ГЛАВНАЯ"},{id:"shop",icon:"🧺",label:"ЛАВКА"},{id:"friends",icon:"👤",label:"ДРУЗЬЯ"},{id:"guilds",icon:"🔱",label:"АРТЕЛИ"},{id:"book",icon:"📖",label:"КНИГА"}],I={name:"АКВАМАН_01",tag:"@aquaman01",level:15,xp:7200,maxXp:1e4,avatar:"🤿"},E={common:"#90e0ef",rare:"#00b4d8",legendary:"#f4a82e",aquarium:"#4cc9f0",mythical:"#ef476f",anomaly:"#7b2cbf"},_t=()=>{var i,t;return((t=(i=window.Telegram)==null?void 0:i.WebApp)==null?void 0:t.initData)||""};async function h(i,t={}){const s={"Content-Type":"application/json","X-Telegram-Init-Data":_t(),...t.headers||{}},a=await fetch(i,{...t,headers:s});if(!a.ok){const n=await a.json().catch(()=>({error:"Unknown error"}));throw new Error(n.error||`HTTP error! status: ${a.status}`)}return a.json()}const X=h;class It{constructor(){this.fillEl=null,this.wobbling=!1,this.profile={...I},this.el=this.build(),this.loadProfile()}async loadProfile(){try{const t=await h("/api/profile");t&&(this.profile.name=t.username||this.profile.name,this.profile.level=t.level||this.profile.level,this.profile.xp=t.xp||this.profile.xp,this.profile.maxXp=1e4,this.profile.tag=`@${t.user_id}`||this.profile.tag,this.updateUI())}catch(t){console.error("Failed to load profile:",t)}}updateUI(){const t=this.el.querySelector("#profile-name"),e=this.el.querySelector("#profile-tag"),s=this.el.querySelector(".level-label"),a=this.el.querySelector(".xp-label");t&&(t.textContent=this.profile.name.toUpperCase()),e&&(e.textContent=this.profile.tag),s&&(s.textContent=`Уровень ${this.profile.level}`),a&&(a.textContent=`${this.profile.xp.toLocaleString("ru")} XP`),this.animateProgress(0)}getElement(){return this.el}build(){const t=I,e=Math.round(t.xp/t.maxXp*100),s=document.createElement("div");s.id="profile-panel",s.className="profile-panel glass",s.innerHTML=`
    ...
    `,this.container.appendChild(t),setTimeout(()=>t.remove(),(a+.5)*1e3)}start(){this.intervalId=window.setInterval(()=>this.spawnOne(),380)}stop(){clearInterval(this.intervalId),this.container.querySelectorAll(".trophy-bubble").forEach(t=>t.remove())}restart(){this.stop(),this.start()}}const N=class N{static transitionTo(t,e){this.pendingTimeout&&(clearTimeout(this.pendingTimeout),this.pendingTimeout=0);const s=++this.transitionToken;t.style.transition="opacity 0.35s ease, transform 0.35s ease",t.style.opacity="0",t.style.transform="scale(0.93)",t.style.pointerEvents="none",t.classList.remove("is-active"),e.style.display="flex",e.style.transition="none",e.style.opacity="0",e.style.transform="scale(1.06)",e.style.pointerEvents="all",e.classList.add("is-active"),this.pendingTimeout=window.setTimeout(()=>{s===this.transitionToken&&(t.style.display="none",t.style.opacity="",t.style.transform="",t.style.transition="",requestAnimationFrame(()=>{s===this.transitionToken&&(e.style.transition="opacity 0.38s cubic-bezier(0.25,0.46,0.45,0.94), transform 0.38s cubic-bezier(0.25,0.46,0.45,0.94)",e.style.opacity="1",e.style.transform="scale(1)")}))},300)}};N.transitionToken=0,N.pendingTimeout=0;let J=N;const Bt={id:"no-trophy",emoji:"🐟",name:"Нет трофеев",latinName:"",rarity:"common",rarityLabel:"Обычная",rarityStars:"",weight:"0 кг",depth:"0 см"};class Ft{constructor(t,e=2){this.cards=[],this.bubbleSpawner=null,this.fishData=[],this.startX=0,this.isDragging=!1,this.onChangeCallback=null,this.container=t,this.activeIndex=e,this.build(),this.bindSwipe(),this.update()}build(){this.container.innerHTML="",this.cards=[];const t=document.createElement("div");t.className="carousel__bubbles",this.container.appendChild(t),this.bubbleSpawner=new Ht(t);const e=document.createElement("div");if(e.className="carousel__track",this.container.appendChild(e),this.fishData.length===0){e.innerHTML=`
      ...
      `;return}this.fishData.forEach((s,a)=>{const n=document.createElement("div");n.className="carousel__card",n.dataset.index=String(a);const r=E[s.rarity];n.innerHTML=`
        <div class="carousel__card-inner" style="--accent:${r}">
          <div class="carousel__fish-emoji">${s.imageUrl?`<img src="${s.imageUrl}" alt="${s.name}" class="carousel__fish-image" loading="lazy">`:v(s.id)}</div>
      ...
      `,e.appendChild(n),this.cards.push(n)})}update(){var e;if(this.cards.length===0)return;this.cards.forEach((s,a)=>{const n=a-this.activeIndex,r=Math.abs(n);s.classList.remove("is-active","is-side","is-far");let c,d,l,u;switch(r){case 0:c=0,d=1,l=1,u=10,s.classList.add("is-active");break;case 1:c=n*148,d=.78,l=.6,u=5,s.classList.add("is-side");break;case 2:c=n*185,d=.62,l=.28,u=2,s.classList.add("is-far");break;default:c=n*200,d=.5,l=0,u=0}s.style.transform=`translateX(${c}px) scale(${d})`,s.style.opacity=String(l),s.style.zIndex=String(u)});const t=this.fishData[this.activeIndex];t&&((e=this.onChangeCallback)==null||e.call(this,t))}next(){this.fishData.length!==0&&this.activeIndex<this.fishData.length-1&&(this.activeIndex++,this.update(),o.haptic("light"))}prev(){this.fishData.length!==0&&this.activeIndex>0&&(this.activeIndex--,this.update(),o.haptic("light"))}goTo(t){this.fishData.length!==0&&(this.activeIndex=Math.max(0,Math.min(t,this.fishData.length-1)),this.update())}getActiveIndex(){return this.activeIndex}getActiveFish(){return this.fishData[this.activeIndex]||Bt}getItems(){return this.fishData}setFishData(t,e){if(this.fishData=[...t],e){const s=this.fishData.findIndex(a=>a.trophyId===e||a.id===e);this.activeIndex=s>=0?s:0}else this.activeIndex=this.fishData.length?Math.max(0,Math.min(this.activeIndex,this.fishData.length-1)):0;this.build(),this.update()}onChange(t){this.onChangeCallback=t}bindSwipe(){const t=this.container;t.addEventListener("touchstart",e=>{this.startX=e.touches[0].clientX,this.isDragging=!0},{passive:!0}),t.addEventListener("touchend",e=>{if(!this.isDragging)return;const s=e.changedTouches[0].clientX-this.startX;this.handleSwipeEnd(s),this.isDragging=!1},{passive:!0}),t.addEventListener("mousedown",e=>{this.startX=e.clientX,this.isDragging=!0,e.preventDefault()}),window.addEventListener("mouseup",e=>{if(!this.isDragging)return;const s=e.clientX-this.startX;this.handleSwipeEnd(s),this.isDragging=!1})}handleSwipeEnd(t){t<-42?this.next():t>42&&this.prev()}}const Nt={обычная:"common",редкая:"rare",легендарная:"legendary",аквариумная:"aquarium",мифическая:"mythical",аномалия:"anomaly"},Pt={common:"Обычная",rare:"Редкая",legendary:"Легендарная",aquarium:"Аквариумная",mythical:"Мифическая",anomaly:"Аномалия"},Ot={common:"★★",rare:"★★★",legendary:"★★★★★",aquarium:"★★★★",mythical:"★★★★★",anomaly:"★★★★★★"},Dt={common:"#90e0ef",rare:"#00b4d8",legendary:"#f4a82e",aquarium:"#4cc9f0",mythical:"#ef476f",anomaly:"#7b2cbf"};function x(i){const t=String(i||"").trim().toLowerCase();return Nt[t]||"common"}function Z(i){return Pt[x(i)]}function Rt(i){return Ot[x(i)]}function Ut(i){return Dt[x(i)]}let A=[],K="";function jt(i){return`${(Number.isFinite(i)?Math.max(0,i):0).toLocaleString("ru-RU",{maximumFractionDigits:2})} кг`}function Gt(i){return`${(Number.isFinite(i)?Math.max(0,i):0).toLocaleString("ru-RU",{maximumFractionDigits:1})} см`}function Wt(i){const t=i.rarity||"Обычная";return{id:i.id,emoji:"🐟",name:i.fish_name||i.name||"Неизвестная рыба",latinName:"",rarity:x(t),rarityLabel:Z(t),rarityStars:Rt(t),weight:jt(Number(i.weight||0)),depth:Gt(Number(i.length||0)),imageUrl:i.image_url||void 0,trophyId:i.id}}async function Vt(){var i;try{const t=await h("/api/trophies"),e=Array.isArray(t==null?void 0:t.items)?t.items:[];return K=((i=e.find(s=>!!s.is_active))==null?void 0:i.id)||"",A=e.filter(s=>s.id!=="none").map(Wt),A}catch(t){return console.error("Failed to load trophies:",t),A=[],K="",A}}async function zt(i){if(!i)return!1;try{const t=await h("/api/trophy/select",{method:"POST",body:JSON.stringify({trophy_id:i})});return!!(t!=null&&t.ok)}catch(t){return console.error("Failed to select trophy:",t),!1}}class Yt{constructor(){this.isOpen=!1,this.bgBlurTarget=null,this.onSelectCallback=null,this.currentActiveIndex=0,this.items=[],this.sheetStartY=0,this.sheetDragging=!1,this.overlay=this.buildOverlay(),this.sheet=this.overlay.querySelector("#modal-sheet"),this.listEl=this.overlay.querySelector("#modal-fish-list"),document.body.appendChild(this.overlay),this.bindClose()}buildOverlay(){const t=document.createElement("div");return t.id="modal-overlay",t.className="modal-overlay",t.innerHTML=`
    ...
    `,t}buildList(){if(this.items.length===0){this.listEl.innerHTML='<div class="modal-empty">У вас пока нет трофеев</div>';return}this.listEl.innerHTML=this.items.map((t,e)=>{const s=E[t.rarity],a=e===this.currentActiveIndex;return`
        <div
          ...
          aria-label="${t.name}"
        >
          <span class="modal-fish-emoji">${t.imageUrl?`<img src="${t.imageUrl}" alt="${t.name}" class="modal-fish-image" loading="lazy">`:v(t.id)}</span>
        ...
        <div class="ph-content parchment">
          ...
          <div class="ph-fish-block">
            <div class="ph-fish-emoji" style="--glow: ${e?t.glowColor:"#555"}; filter: ${e?"none":"grayscale(100%) contrast(50%) brightness(70%)"}">
              ${t.imageUrl?`<img src="${t.imageUrl}" alt="${t.name}" class="ph-fish-image" loading="lazy">`:v(t.id)}
            </div>
          </div>
          ...
          <div class="ph-rarity-wrap">
            <div class="ph-rarity" style="color:${e?t.glowColor:"#777"}; border-color:${e?t.glowColor:"#777"}55">
              ${e?Kt[t.rarity]:'<span style="color: #ff4d4d; font-weight: bold;">НЕ СЛОВЛЕНА</span>'}
            </div>
          </div>
    ...
    `,document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&document.body.removeChild(e)}),e.querySelectorAll(".sell-opt-btn").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.cat;o.haptic("light"),document.body.removeChild(e),a?this.sellBulk({category:a}):s.classList.contains("select-mode-btn")&&(this.mode="select",this.selectedIds.clear(),this.renderInventory())})})}async showFishDetailModal(t){var e,s,a;try{const n=await h("/api/inventory"),r=((n==null?void 0:n.items)||[]).filter(p=>t.ids.includes(p.id));if(r.length===0)return;const c=x(t.rarity),d=E[c]||"#ccc",l=document.createElement("div");l.className="modal-overlay is-open",l.style.display="flex";const u=`
      ...
      `;l.innerHTML=u,document.body.appendChild(l);let f=new Set,S=null;const C=l.querySelector("#fish-detail-content"),T=l.querySelector(".fish-action-buttons"),w=l.querySelector("#confirm-detail-btn");(e=l.querySelector("#make-trophy-btn"))==null||e.addEventListener("click",()=>{o.haptic("light"),S="trophy",T.style.display="none",C.style.display="block",w.style.display="block",w.textContent="СДЕЛАТЬ ТРОФЕЕМ"}),(s=l.querySelector("#select-to-sell-btn"))==null||s.addEventListener("click",()=>{o.haptic("light"),S="sell",T.style.display="none",C.style.display="block",w.style.display="block",w.textContent="ПРОДАТЬ"}),l.querySelectorAll(".fish-detail-card").forEach(p=>{p.addEventListener("click",()=>{o.haptic("light");const L=parseInt(p.dataset.id||"0");f.has(L)?(f.delete(L),p.classList.remove("selected")):(f.add(L),p.classList.add("selected"))})}),(a=l.querySelector("#cancel-detail-btn"))==null||a.addEventListener("click",()=>{o.haptic("light"),document.body.removeChild(l)}),w==null||w.addEventListener("click",async()=>{if(f.size===0){alert("Выберите хотя бы одну рыбу");return}o.haptic("medium"),document.body.removeChild(l),S==="trophy"?await this.makeTrophies(Array.from(f)):S==="sell"&&await this.sellBulk({ids:Array.from(f)})}),l.addEventListener("click",p=>{p.target===l&&document.body.removeChild(l)})}catch(n){console.error("Failed to load fish details:",n),alert("Ошибка загрузки деталей рыбы")}}async makeTrophies(t){try{let e=0,s=!1,a=0,n=0;for(const r of t){const c=await h("/api/make-trophy",{method:"POST",body:JSON.stringify({id:r})});if(c!=null&&c.ok)e++;else if((c==null?void 0:c.error)==="insufficient_coins"){s=!0,a=c.required||1e4,n=c.current||0;break}}s?alert(`Недостаточно монет!
Требуется: ${a} 🪙
У вас: ${n} 🪙`):e>0&&(o.haptic("success"),alert(`Создано трофеев: ${e}
Списано: ${e*1e4} 🪙`),await this.loadInventory(),window.dispatchEvent(new CustomEvent("refresh-profile")))}catch{alert("Ошибка при создании трофеев")}}async sellBulk(t){try{const e=await h("/api/sell-bulk",{method:"POST",body:JSON.stringify(t)});e&&e.earned_coins!==void 0&&(o.haptic("success"),alert(`Успешно продано!
Получено: ${e.earned_coins} 🪙
Опыт: ${e.earned_xp} ✨`),this.mode="view",this.selectedIds.clear(),await this.loadInventory())}catch{alert("Ошибка при продаже")}}async loadInventory(){this.loading=!0;try{const t=await h("/api/inventory/grouped");this.items=(t==null?void 0:t.items)||[],this.renderInventory()}catch(t){console.error("Failed to load inventory:",t),this.renderError()}finally{this.loading=!1}}renderInventory(){const t=this.el.querySelector("#shop-content"),e=this.el.querySelector("#shop-sell-btn"),s=this.el.querySelector("#shop-select-actions");if(this.mode==="select"?(e.style.display="none",s.style.display="flex",this.updateSelectCount()):(e.style.display=this.items.length>0?"block":"none",s.style.display="none"),this.items.length===0){t.innerHTML=`
        <div class="shop-empty">
          <div class="shop-soon-icon">${v("shop")}</div>
          <h3>Садок пуст</h3>
      ...
      <div class="inventory-grid">
        ${this.items.map((a,n)=>{const r=x(a.rarity),c=E[r]||"#ccc",d=a.ids.every(f=>this.selectedIds.has(f)),l=a.ids.some(f=>this.selectedIds.has(f))&&!d;let u="";return this.mode==="select"&&(d?u="is-selected":l&&(u="is-partial")),`
            <div class="inv-card glass ${u}" style="--card-color: ${c}" data-idx="${n}">
              ...
              <div class="inv-details">
                ...
                <div class="inv-rarity" style="color:${c}">${Z(a.rarity)}</div>
    ...
    `}}const ht=["guild_beer","guild_rich","guild_cthulhu","guild_king"],ut=["#00b4d8","#f4a82e","#9b5de5","#ff6b6b","#a5a5a5","#4d908e"];let g=[],y=null,m=null,H=!1,B=!1;const pt={1:5,2:10,3:20};function ee(i,t){const e=Number(t);return e>0?e:pt[i]??pt[3]??20}function M(i,t=0){return i.length>0?i.length:Math.max(0,Number(t)||0)}const P=i=>({userId:String(i.user_id??i.userId??""),name:String(i.username||i.name||"user"),level:Number(i.level||0),role:i.role||"member",totalWeight:Number(i.total_weight||i.totalWeight||i.tournament_weight||0)});function mt(i,t){const e=Array.isArray(i.members)?i.members.map(P):(t==null?void 0:t.members)||[],s=(t==null?void 0:t.requests)??(Array.isArray(i.requests)?i.requests.map(n=>({requestId:String(n.request_id??n.id??""),userId:String(n.user_id??n.requester_user_id??""),name:String(n.username||"user"),level:Number(n.level||0),userAvatar:String(n.user_avatar||"👤")})):[]),a=(t==null?void 0:t.upgradeProgress)??(Array.isArray(i.upgrade_progress)?i.upgrade_progress.map(n=>({item:String(n.item||""),required:Number(n.required||0),current:Number(n.current||0)})):[]);return{id:String(i.id),name:i.name,avatar:i.avatar_emoji||"🔱",borderColor:i.color_hex||"#00b4d8",type:i.access_type||"open",level:i.level||1,members:e,requests:s,upgradeProgress:a,memberCount:M(e,i.members_count??i.member_count),capacity:ee(i.level||1,i.max_members),minLevel:i.min_level||0,totalWeight:Number(i.total_catch_weight||0),totalFish:Number(i.total_catch_count||0),canUpgrade:!!i.can_upgrade,...t}}function vt(){return y||m&&g.find(i=>i.id===m)||null}async function $(){try{const i=await h("/api/guilds");if(i&&i.ok){B=!!i.is_admin,g=(i.items||[]).map(e=>mt(e));const t=i.my_clan;if(t&&t.id){const e=Array.isArray(t.members)?t.members.map(P):[],s=Array.isArray(t.requests)?t.requests.map(r=>({requestId:String(r.request_id??r.id??""),userId:String(r.user_id??r.requester_user_id??""),name:String(r.username||"user"),level:Number(r.level||0),userAvatar:String(r.user_avatar||"👤")})):[],a=Array.isArray(t.upgrade_progress)?t.upgrade_progress.map(r=>({item:String(r.item||""),required:Number(r.required||0),current:Number(r.current||0)})):[];y=mt(t,{members:e,requests:s,upgradeProgress:a,canUpgrade:!!t.can_upgrade}),m=y.id,H=t.role==="leader";const n=g.findIndex(r=>r.id===y.id);n>=0?g[n]=y:g.unshift(y)}else y=null,m=null,H=!1}}catch(i){console.error("Failed to load clans:",i)}}async function se(i){var t,e;try{const s=await h("/api/guilds/create",{method:"POST",body:JSON.stringify({name:i.name,avatar:i.avatar,color:i.borderColor,type:i.type,min_level:i.minLevel})});if(s&&s.ok)return await $(),g.find(a=>a.id===String(s.clan_id))||null;if(s&&!s.ok)if(s.reason==="not_enough_coins")alert(`Недостаточно монет для создания артели! Нужно ${s.cost.toLocaleString()} 🪙`);else if(s.reason==="tournament_active"){const a=((t=s.tournament)==null?void 0:t.ends_at)||((e=s.tournament)==null?void 0:e.endsAt),n=a?` до ${String(a).replace("T"," ").slice(0,16)}`:"";alert(`Во время турнира нельзя создавать артели${n}.`)}else alert(`Ошибка создания: ${s.reason||"неизвестная ошибка"}`)}catch(s){console.error("Failed to create guild:",s)}return null}async function ie(i){const t=g.find(e=>e.id===i);if(!t)return!1;try{const e=t.type==="open"?"/api/guilds/join":"/api/guilds/apply",s=await h(e,{method:"POST",body:JSON.stringify({guild_id:i})});if(s&&s.ok)return t.type==="open"&&(m=t.id),!0;s&&!s.ok&&(s.reason==="level_too_low"?alert(`Ваш уровень слишком низок! Требуется уровень ${s.required}`):s.reason==="not_enough_coins"?alert(`Недостаточно монет! Требуется ${s.cost} 🪙`):alert(`Ошибка: ${s.reason||s.error||"неизвестная ошибка"}`))}catch(e){console.error("Failed to join guild:",e)}return!1}async function gt(i,t){try{const e=await h("/api/guilds/request/respond",{method:"POST",body:JSON.stringify({request_id:i,action:t})});if(e&&e.ok)return await $(),!0;e&&!e.ok&&alert(`Ошибка обработки заявки: ${e.error||"неизвестная ошибка"}`)}catch(e){console.error("Failed to respond to clan request:",e)}return!1}async function ae(){if(m)try{const i=await h("/api/guilds/leave",{method:"POST"});if(i&&i.ok){m=null,y=null,H=!1,B=!!(i.is_admin||B),await $();return}i&&!i.ok&&alert(`Не удалось покинуть артель: ${i.reason||i.error||"неизвестная ошибка"}`)}catch(i){console.error("Failed to leave guild:",i)}}async function z(i){try{const t=await h(`/api/guilds/members?guild_id=${encodeURIComponent(i)}`);if(t&&t.ok){const e=Array.isArray(t.members)?t.members.map(P):[],s=g.find(a=>a.id===i);return s&&(s.members=e,s.memberCount=M(e,t.members_count)),y&&y.id===i&&(y.members=e,y.memberCount=M(e,t.members_count)),e}}catch(t){console.error("Failed to load clan members:",t)}return[]}async function ne(i,t=1){try{const e=await h("/api/guilds/donate",{method:"POST",body:JSON.stringify({item_name:i,quantity:t})});if(e&&e.ok)return await $(),!0;e&&!e.ok&&(e.reason==="not_enough_trash"?alert(`Недостаточно предметов. Есть ${e.available||0} из ${e.required||t}.`):alert(`Ошибка пожертвования: ${e.reason||e.error||"неизвестная ошибка"}`))}catch(e){console.error("Failed to donate to guild:",e)}return!1}async function re(){try{const i=await h("/api/guilds/upgrade",{method:"POST"});if(i&&i.ok)return await $(),!0;i&&!i.ok&&alert(`Не удалось улучшить артель: ${i.reason||i.error||"неизвестная ошибка"}`)}catch(i){console.error("Failed to upgrade guild:",i)}return!1}async function le(i){try{const t=await h("/api/guilds/members/remove",{method:"POST",body:JSON.stringify({member_id:i})});if(t&&t.ok)return await $(),!0;t&&!t.ok&&alert(`Не удалось удалить участника: ${t.reason||t.error||"неизвестная ошибка"}`)}catch(t){console.error("Failed to remove guild member:",t)}return!1}function Y(i,t,e){return{id:String(i.id),title:String(i.title||""),startsAt:String(i.starts_at||""),endsAt:String(i.ends_at||""),createdBy:String(i.created_by||""),createdAt:String(i.created_at||""),isActive:t===String(i.id),phase:e==="active"||e==="grace"?e:void 0}}async function oe(){try{const i=await h("/api/guilds/tournaments");if(i&&i.ok){const t=i.active_id?String(i.active_id):null,e=i.visible_id?String(i.visible_id):null,s=i.phase==="active"||i.phase==="grace"?i.phase:null,a=(i.items||[]).map(c=>Y(c,t)),n=i.active?Y(i.active,t,"active"):null,r=i.visible?Y(i.visible,e,s||void 0):null;return{items:a,activeId:t,active:n,visibleId:e,visible:r,phase:s}}}catch(i){console.error("Failed to load clan tournaments:",i)}return{items:[],activeId:null,active:null,visibleId:null,visible:null,phase:null}}async function ce(i,t){try{const e=await h(`/api/guilds/tournaments/members?guild_id=${encodeURIComponent(i)}&tournament_id=${encodeURIComponent(t)}`);if(e&&e.ok)return Array.isArray(e.members)?e.members.map(P):[]}catch(e){console.error("Failed to load tournament members:",e)}return[]}async function de(i,t,e){try{const s=await h("/api/guilds/tournaments/create",{method:"POST",body:JSON.stringify({title:i,starts_at:t,ends_at:e})});if(s&&s.ok&&s.tournament){const a=s.tournament;return{id:String(a.id),title:String(a.title||""),startsAt:String(a.starts_at||""),endsAt:String(a.ends_at||""),createdBy:String(a.created_by||""),createdAt:String(a.created_at||""),isActive:!1}}}catch(s){console.error("Failed to create clan tournament:",s)}return null}async function he(i){try{const t=await h(`/api/guilds/tournaments/leaderboard?tournament_id=${encodeURIComponent(i)}`);if(t&&t.ok)return(t.items||[]).map(e=>({clanId:String(e.clan_id??e.clanId??""),name:String(e.name||""),totalWeight:Number(e.total_weight||0),totalFish:Number(e.total_fish||0)}))}catch(t){console.error("Failed to load clan tournament leaderboard:",t)}return[]}class ue{constructor(){this.tab="list",this.loading=!1,this.newGuildName="",this.selectedAvatar=ht[0],this.selectedColor=ut[0],this.selectedType="open",this.selectedMinLevel=0,this.visibleTournament=null,this.tournamentPhase=null,this.tournamentLeaderboard=[],this.showAdminTournamentForm=!1,this.tournamentTitle="",this.tournamentStarts="",this.tournamentEnds="",this.clanModalGuildId=null,this.clanModalGuildName="",this.clanModalMembers=[],this.clanModalLoading=!1,this.clanModalTournament=!1,this.el=this.buildShell(),this.modalHost=document.createElement("div"),this.modalHost.id="guild-modals-root",this.modalHost.className="guild-modals-root",document.body.appendChild(this.modalHost)}getElement(){return this.el}buildShell(){const t=document.createElement("section");return t.id="screen-guilds",t.className="screen guilds-screen",t.setAttribute("role","main"),t}async init(){this.loading=!0,this.tab=m?"my":"list",this.render(),await $(),m&&await z(m),await this.refreshTournaments(),this.loading=!1,this.render()}async refreshTournaments(){const t=await oe();this.visibleTournament=t.visible||null,this.tournamentPhase=t.phase,this.visibleTournament?this.tournamentLeaderboard=await he(this.visibleTournament.id):(this.tournamentLeaderboard=[],this.tab==="tournament"&&(this.tab="rating"))}formatWeight(t){return Number(t||0).toLocaleString("ru-RU",{minimumFractionDigits:2,maximumFractionDigits:2})}formatDate(t){if(!t)return"";const e=String(t);return e.includes("T")?e.replace("T"," ").slice(0,16):e.slice(0,16)}showTournamentTab(){return!!this.visibleTournament}renderTabs(){const t=[];return m&&t.push({id:"my",label:"МОЯ"}),t.push({id:"list",label:"АРТЕЛИ"}),t.push({id:"rating",label:"РЕЙТИНГ"}),this.showTournamentTab()&&t.push({id:"tournament",label:"ТУРНИР"}),`
      <div class="guild-tabs">
        ${t.map(e=>`
          <button type="button" class="guild-tab ${this.tab===e.id?"is-active":""}" data-tab="${e.id}">${e.label}</button>
        `).join("")}
      </div>
    `}render(){if(this.loading){this.el.innerHTML='<div class="guild-loading">Загрузка...</div>';return}if(this.tab==="create"){this.renderCreate();return}const t=B?`
    ...
    `).join(""):'<div class="members-empty">Пока нет артелей.</div>';return`
      <div class="guilds-header">
        ${m?"":'<button type="button" class="guild-create-btn" id="guild-create-trigger">СОЗДАТЬ АРТЕЛЬ</button>'}
      </div>
      <div class="guild-list">${t}</div>
    `}bindTabContent(){this.tab==="list"&&this.bindList(),this.tab==="my"&&this.bindManage(),this.tab==="rating"&&this.bindRating(),this.tab==="tournament"&&this.bindTournament()}bindList(){var t;(t=this.el.querySelector("#guild-create-trigger"))==null||t.addEventListener("click",()=>{this.tab="create",this.render(),o.haptic("medium")}),this.el.querySelectorAll(".guild-join-btn").forEach(e=>{e.addEventListener("click",async s=>{s.stopPropagation();const a=e.getAttribute("data-id");if(await ie(a)){o.haptic("heavy");const r=g.find(c=>c.id===a);(r==null?void 0:r.type)==="invite"?alert("Заявка отправлена!"):(this.tab="my",await this.init())}else o.haptic("error")})})}renderRatingContent(){return`
      ...
      <div class="guild-rating-list">
        ${[...g].sort((e,s)=>s.totalWeight-e.totalWeight).map((e,s)=>`
          <button type="button" class="guild-rating-card glass" data-id="${e.id}" data-tournament="0">
            ...
            <div class="guild-info">
              ...
              <div class="guild-meta">
                <span>👤 ${M(e.members,e.memberCount)}</span>
    ...
    `}bindRating(){this.el.querySelectorAll('.guild-rating-card[data-tournament="0"]').forEach(t=>{t.addEventListener("click",async()=>{const e=t.getAttribute("data-id");if(!e)return;const s=g.find(n=>n.id===e);this.clanModalGuildId=e,this.clanModalGuildName=(s==null?void 0:s.name)||"Артель",this.clanModalTournament=!1,this.clanModalLoading=!0,this.clanModalMembers=[],this.renderModals(),await z(e);const a=g.find(n=>n.id===e);this.clanModalMembers=(a==null?void 0:a.members)||[],this.clanModalLoading=!1,this.renderModals()})})}renderTournamentContent(){const t=this.visibleTournament;if(!t)return'<div class="members-empty">Турнир недоступен.</div>';const e=this.tournamentPhase==="grace"?"Турнир завершён — итоги ещё сутки":"Идёт турнир",s=`${this.formatDate(t.startsAt)} → ${this.formatDate(t.endsAt)}`,a=this.tournamentLeaderboard.length?this.tournamentLeaderboard.map((n,r)=>`
    ...
    `}bindTournament(){this.el.querySelectorAll('[data-tournament="1"]').forEach(t=>{t.addEventListener("click",async()=>{const e=t.getAttribute("data-id");if(!e||!this.visibleTournament)return;const s=this.tournamentLeaderboard.find(a=>a.clanId===e);this.clanModalGuildId=e,this.clanModalGuildName=(s==null?void 0:s.name)||"Артель",this.clanModalTournament=!0,this.clanModalLoading=!0,this.clanModalMembers=[],this.renderModals(),this.clanModalMembers=await ce(e,this.visibleTournament.id),this.clanModalLoading=!1,this.renderModals()})})}renderClanModalHtml(){const t=this.clanModalTournament?"Улов за турнир":"Улов в артели",e=this.clanModalLoading?'<div class="members-empty">Загрузка...</div>':this.clanModalMembers.length?[...this.clanModalMembers].sort((s,a)=>a.totalWeight-s.totalWeight).map((s,a)=>`
    ...
    `}bindClanModal(){var e,s;const t=()=>{this.clanModalGuildId=null,this.clanModalMembers=[],this.renderModals()};(e=this.modalHost.querySelector("#clan-modal-close"))==null||e.addEventListener("click",t),(s=this.modalHost.querySelector("#clan-modal-backdrop"))==null||s.addEventListener("click",a=>{a.target===a.currentTarget&&t()})}renderAdminTournamentModalHtml(){return`
    ...
    `}bindAdminTournamentModal(){var n,r,c;const t=()=>{this.showAdminTournamentForm=!1,this.renderModals()};(n=this.modalHost.querySelector("#admin-tournament-close"))==null||n.addEventListener("click",t),(r=this.modalHost.querySelector("#admin-tournament-backdrop"))==null||r.addEventListener("click",d=>{d.target===d.currentTarget&&t()});const e=this.modalHost.querySelector("#tournament-title");e==null||e.addEventListener("input",()=>{this.tournamentTitle=e.value});const s=this.modalHost.querySelector("#tournament-start");s==null||s.addEventListener("input",()=>{this.tournamentStarts=s.value});const a=this.modalHost.querySelector("#tournament-end");a==null||a.addEventListener("input",()=>{this.tournamentEnds=a.value}),(c=this.modalHost.querySelector("#tournament-create"))==null||c.addEventListener("click",async()=>{const d=this.tournamentTitle.trim();if(!d||!this.tournamentStarts||!this.tournamentEnds){alert("Заполните название и даты.");return}await de(d,this.tournamentStarts,this.tournamentEnds)?(this.tournamentTitle="",this.tournamentStarts="",this.tournamentEnds="",this.showAdminTournamentForm=!1,await this.refreshTournaments(),this.tab="tournament",o.haptic("heavy"),this.render()):(alert("Не удалось создать турнир."),o.haptic("error"))})}renderManageContent(){const t=vt();if(!t)return'<div class="members-empty">Вы не состоите в артели.</div>';const e=H,s=[...t.members||[]].sort((l,u)=>u.totalWeight-l.totalWeight),a=M(s,t.memberCount),n=t.upgradeProgress||[],r=[...g].sort((l,u)=>u.totalWeight-l.totalWeight).findIndex(l=>l.id===t.id),c=r>=0?`#${r+1}`:"—",d=`
      <div class="glass" style="padding: 12px; margin-bottom: 12px;">
        <p class="form-label" style="margin-bottom: 10px; color: var(--gold); font-size: 10px;">
          ${n.length?`Улучшение до ур. ${t.level+1}`:"Максимальный уровень"}
        </p>
        ${n.length?`
            ...
            ${n.map((l,u)=>`
              <div class="upgrade-item">
                <div class="upgrade-main">
                  <div class="upgrade-labels"><span>${l.item}</span><span>${l.current}/${l.required}</span></div>
                  <div class="upgrade-bar"><div class="upgrade-fill" style="width: ${l.current/l.required*100}%"></div></div>
                </div>
                <button type="button" class="donate-btn" data-idx="${u}">ВКЛАД</button>
              </div>
            `).join("")}
          </div>
          ${e?`<button type="button" class="guild-create-btn" id="guild-upgrade" ${t.canUpgrade?"":"disabled"}>${t.canUpgrade?"УЛУЧШИТЬ":"НУЖНЫ РЕСУРСЫ"}</button>`:""}
    ...
    `;return`
      <div class="glass guild-my-header" style="padding: 12px; display:flex; align-items:center; gap:12px; margin-bottom:12px;">
        <div class="guild-avatar" style="width:64px; height:64px; font-size:32px; --border-color:${t.borderColor}">${v(t.avatar)}</div>
        <div class="guild-info">
      ...
      <div class="glass members-panel">
        ...
        <div class="members-list">
          ${s.length?s.map((l,u)=>`
            <div class="member-row">
              <div class="member-rank">#${u+1}</div>
              <div class="member-name">${l.name}${l.role==="leader"?" 👑":""}</div>
              <div class="member-meta">Ур. ${l.level}</div>
              <div class="member-weight">${this.formatWeight(l.totalWeight)} кг</div>
              ${e&&l.role!=="leader"?`<button type="button" class="member-remove-btn" data-id="${l.userId}">✕</button>`:""}
            </div>
          ...
          <div class="requests-list">
            ${t.requests.map(l=>`
              <div class="request-card glass" style="padding: 8px;">
                <div class="req-avatar" style="font-size:20px;">${l.userAvatar}</div>
                <div class="req-info">
                  <div class="req-name" style="font-size:12px;">${l.name}</div>
                  <div class="req-lvl" style="font-size:9px;">Ур. ${l.level}</div>
                </div>
                <div class="req-btns">
                  <button type="button" class="req-btn req-btn--no" data-req="${l.requestId}">✕</button>
                  <button type="button" class="req-btn req-btn--yes" data-req="${l.requestId}">✓</button>
                </div>
              </div>
            `).join("")}
          </div>
    ...
    `}bindManage(){var e,s;const t=vt();t&&((e=this.el.querySelector("#btn-leave"))==null||e.addEventListener("click",async()=>{confirm("Покинуть артель? Ваш улов останется в статистике этой артели.")&&(await ae(),o.haptic("medium"),this.tab="list",await this.init())}),this.el.querySelectorAll(".donate-btn").forEach(a=>{a.addEventListener("click",()=>{const n=parseInt(a.getAttribute("data-idx"),10),r=t.upgradeProgress[n];ne(r.item,1).then(c=>{o.haptic(c?"selection":"error"),c&&this.init()})})}),(s=this.el.querySelector("#guild-upgrade"))==null||s.addEventListener("click",async()=>{const a=await re();o.haptic(a?"heavy":"error"),a&&await this.init()}),this.el.querySelectorAll(".req-btn--yes").forEach(a=>{a.addEventListener("click",async()=>{const n=a.getAttribute("data-req");n&&await gt(n,"accept")&&await this.init()})}),this.el.querySelectorAll(".req-btn--no").forEach(a=>{a.addEventListener("click",async()=>{const n=a.getAttribute("data-req");n&&await gt(n,"decline")&&await this.init()})}),this.el.querySelectorAll(".member-remove-btn").forEach(a=>{a.addEventListener("click",async()=>{const n=a.getAttribute("data-id");!n||!confirm("Удалить участника?")||await le(n)&&await this.init()})}))}renderCreate(){var s,a;this.el.innerHTML=`
      ...
      <div class="glass artel-form" style="padding: 20px;">
        ...
        <div class="form-group">
          ...
          <div class="avatar-grid">
            ${ht.map(n=>`<div class="avatar-opt ${this.selectedAvatar===n?"is-selected":""}" data-val="${n}">${v(n)}</div>`).join("")}
          </div>
        </div>
        <div class="form-group">
          <label class="form-label">Цвет</label>
          <div class="color-row">
            ${ut.map(n=>`<div class="color-opt ${this.selectedColor===n?"is-selected":""}" data-val="${n}" style="background:${n}"></div>`).join("")}
          </div>
        </div>
        <div class="form-group">
    ...
    `;const t=this.el.querySelector("#guild-name-input");t==null||t.addEventListener("input",()=>{this.newGuildName=t.value}),this.el.querySelectorAll(".avatar-opt").forEach(n=>{n.addEventListener("click",()=>{this.selectedAvatar=n.getAttribute("data-val"),this.render()})}),this.el.querySelectorAll(".color-opt").forEach(n=>{n.addEventListener("click",()=>{this.selectedColor=n.getAttribute("data-val"),this.render()})}),this.el.querySelectorAll(".type-opt").forEach(n=>{n.addEventListener("click",()=>{this.selectedType=n.getAttribute("data-val"),this.render()})});const e=this.el.querySelector("#min-level-slider");e==null||e.addEventListener("input",()=>{this.selectedMinLevel=parseInt(e.value,10);const n=this.el.querySelector("#min-level-label");n&&(n.textContent=`Мин. уровень: ${this.selectedMinLevel}`)}),(s=this.el.querySelector("#create-cancel"))==null||s.addEventListener("click",()=>{this.tab=m?"my":"list",this.render()}),(a=this.el.querySelector("#create-confirm"))==null||a.addEventListener("click",async()=>{if(this.newGuildName.trim().length<3){alert("Слишком короткое название!");return}await se({name:this.newGuildName,avatar:this.selectedAvatar,borderColor:this.selectedColor,type:this.selectedType,minLevel:this.selectedMinLevel})?(o.haptic("heavy"),this.tab="my",await this.init()):o.haptic("error")})}}let tt=[],q=[];async function F(){try{const i=await h("/api/friends");if(i&&i.ok){const t=Array.isArray(i.items)?i.items:[],e=Array.isArray(i.incoming_requests)?i.incoming_requests:[];tt=t.map(s=>({id:String(s.user_id),name:s.username,level:Number(s.level||0),avatar:"👤",online:!!s.is_online,xp:Number(s.xp||0)})),q=e.map(s=>({id:String(s.request_id||s.id),name:String(s.username||"user"),level:Number(s.level||0),avatar:"👤"}))}}catch(i){console.error("Failed to load friends:",i)}}async function pe(i){try{const t=await h("/api/friends/add",{method:"POST",body:JSON.stringify({username:i})});return!!(t!=null&&t.ok)}catch(t){return console.error("Failed to send friend request:",t),!1}}async function me(i){return yt(i,"accept")}async function ve(i){return yt(i,"decline")}async function yt(i,t){try{const e=await h("/api/friends/request/respond",{method:"POST",body:JSON.stringify({request_id:i,action:t})});if(e!=null&&e.ok)return await F(),!0}catch(e){console.error("Failed to respond friend request:",e)}return!1}class ge{constructor(){this.currentView="list",this.loading=!1,this.el=this.buildShell()}getElement(){return this.el}buildShell(){const t=document.createElement("section");return t.id="screen-friends",t.className="screen friends-screen",t.setAttribute("role","main"),t}async init(){this.loading=!0,this.render(),await F(),this.loading=!1,this.render()}render(){if(this.loading){this.el.innerHTML='<div style="display:flex; justify-content:center; align-items:center; height:100%; color:white;">Загрузка...</div>';return}this.currentView==="requests"?this.renderRequests():this.renderList()}renderList(){var t,e;this.el.innerHTML=`
      <div class="friends-header-row">
        ...
        <div class="friends-notif-btn" id="btn-show-requests">
          <span>🔔</span>
          ${q.length>0?`<div class="notif-badge">${q.length}</div>`:""}
        </div>
      </div>
      ...
      <div class="friends-list" style="margin-top: 20px; display:flex; flex-direction:column; gap:10px;">
        ${tt.length===0?'<p style="text-align:center; opacity:0.5; font-size:12px; margin-top:20px;">У вас пока нет друзей</p>':""}
        ${tt.map(s=>`
    ...
    `,(t=this.el.querySelector("#btn-show-requests"))==null||t.addEventListener("click",()=>{this.currentView="requests",this.render(),o.haptic("medium")}),(e=this.el.querySelector("#btn-add-search"))==null||e.addEventListener("click",async()=>{const s=this.el.querySelector("#friend-search");s.value.trim()&&(await pe(s.value.trim())?(alert("Запрос отправлен!"),s.value="",o.haptic("light"),await F(),this.render()):(o.haptic("error"),alert("Не удалось отправить заявку.")))})}renderRequests(){var t;this.el.innerHTML=`
      ...
      <div class="requests-list" style="margin-top: 20px; display:flex; flex-direction:column; gap:10px;">
        ${q.length===0?'<p style="text-align:center; opacity:0.5; font-size:12px; margin-top:40px;">Нет новых заявок</p>':""}
        ${q.map(e=>`
    ...
    `,(t=this.el.querySelector("#btn-back-list"))==null||t.addEventListener("click",()=>{this.currentView="list",this.render(),o.haptic("light")}),this.el.querySelectorAll(".req-btn--yes").forEach(e=>{e.addEventListener("click",async()=>{const s=e.getAttribute("data-id"),a=await me(s);o.haptic(a?"heavy":"error"),this.render()})}),this.el.querySelectorAll(".req-btn--no").forEach(e=>{e.addEventListener("click",async()=>{const s=e.getAttribute("data-id"),a=await ve(s);o.haptic(a?"medium":"error"),this.render()})})}}class fe{constructor(){this.currentType="normal",this.isLoading=!1,this.el=this.build()}build(){const t=document.createElement("section");return t.id="screen-rating",t.className="screen",t.setAttribute("role","main"),t.setAttribute("aria-label","Рейтинг"),t.innerHTML=`
    ...
    `,t}getElement(){return this.el}async init(){this.bindEvents(),await this.loadRating()}bindEvents(){setTimeout(()=>{const e=this.el.querySelector("#rating-back-btn");e&&e.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),console.log("Rating back button clicked");const a=new CustomEvent("navigate-home");window.dispatchEvent(a)})},100);const t=this.el.querySelectorAll(".rating-tab");t.forEach(e=>{e.addEventListener("click",()=>{const s=e.dataset.type;s===this.currentType||this.isLoading||(o.haptic("selection"),t.forEach(a=>a.classList.remove("is-active")),e.classList.add("is-active"),this.currentType=s,this.loadRating())})})}async loadRating(){if(this.isLoading)return;this.isLoading=!0;const t=this.el.querySelector("#rating-list"),e=this.el.querySelector("#rating-my-rank");t.innerHTML='<div class="rating-loading">Загрузка...</div>',e.innerHTML='<div class="rating-loading">Загрузка...</div>';try{const s=await X(`/api/tickets/rating?ticket_type=${this.currentType}&limit=50`);if(!s.ok||!s.items)throw new Error("Failed to load rating");this.renderMyRank(e,s.my_rank,s.ticket_type),this.renderList(t,s.items)}catch(s){console.error("Failed to load rating:",s),t.innerHTML='<div class="rating-error">Ошибка загрузки рейтинга</div>',e.innerHTML='<div class="rating-error">Ошибка загрузки</div>'}finally{this.isLoading=!1}}renderMyRank(t,e,s){const a=s==="gold"?"🎫":"🎟️",n=s==="gold"?"золотых":"обычных";if(e===null||e===0)t.innerHTML=`
      ...
      `}).join("");t.innerHTML=s}escapeHtml(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}}const be=793216884;class ye{constructor(){this.currentType="normal",this.isLoading=!1,this.isOwner=!1,this.el=this.build(),this.checkOwner()}checkOwner(){const t=o.getUser();this.isOwner=(t==null?void 0:t.id)===be}build(){const t=document.createElement("section");return t.id="screen-results",t.className="screen",t.setAttribute("role","main"),t.setAttribute("aria-label","Результаты"),t.innerHTML=`
      <div class="screen-header">
    ...
    `:"",n=e.items.map(l=>{const u=l.place===1?"🥇":l.place===2?"🥈":l.place===3?"🥉":"🎖️";return`
        <div class="results-winner ${l.place<=3?"results-winner-top":""}">
          <div class="results-winner-place">
            <span class="results-medal">${u}</span>
            <span class="results-place-number">#${l.place}</span>
          </div>
          <div class="results-winner-info">
            <div class="results-winner-username">${this.escapeHtml(l.username)}</div>
            <div class="results-winner-id">ID: ${l.user_id}</div>
            <div class="results-winner-ticket">Билет: <strong>${l.ticket_code}</strong></div>
          </div>
        </div>
      `}).join("");t.innerHTML=`
      ${a}
    ...
    `;const r=t.querySelector("#results-toggle-btn"),c=t.querySelector("#results-winners-list"),d=t.querySelector(".results-period-btn-arrow");r&&c&&r.addEventListener("click",()=>{const l=c.style.display!=="none";c.style.display=l?"none":"flex",d&&(d.textContent=l?"▼":"▲"),o.haptic("selection")})}formatDate(t){try{return new Date(t).toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return t}}escapeHtml(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}}class we{constructor(){this.token="",this.challenge=null,this.loading=!1,this.el=this.buildShell()}getElement(){return this.el}buildShell(){const t=document.createElement("section");return t.id="screen-captcha",t.className="screen captcha-screen",t.setAttribute("role","main"),t.innerHTML=`
