(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();class re{constructor(){var e;this.tg=((e=window.Telegram)==null?void 0:e.WebApp)??null,this.tg&&(this.tg.ready(),this.tg.expand(),this.tg.setHeaderColor("#0a1628"),this.tg.setBackgroundColor("#0a1628"))}haptic(e){var t;(t=this.tg)!=null&&t.HapticFeedback&&(e==="selection"?this.tg.HapticFeedback.selectionChanged():e==="success"||e==="error"?this.tg.HapticFeedback.notificationOccurred(e):e==="impact"?this.tg.HapticFeedback.impactOccurred("medium"):["light","medium","heavy"].includes(e)&&this.tg.HapticFeedback.impactOccurred(e))}getUserName(){var e,t,i;return((i=(t=(e=this.tg)==null?void 0:e.initDataUnsafe)==null?void 0:t.user)==null?void 0:i.first_name)??null}getUserTag(){var t,i,a;const e=(a=(i=(t=this.tg)==null?void 0:t.initDataUnsafe)==null?void 0:i.user)==null?void 0:a.username;return e?`@${e}`:null}}const n=new re,H={home:`
  ...
  `};function c(s,e=""){const t=H[s]||H.home;return e?t.replace("<svg",`<svg class="${e}"`):t}function ne(){const s=document.getElementById("app");return s.innerHTML=`
      ...
      <section id="screen-home" class="screen is-active" role="main" aria-label="Главная">
        ...
        <div class="quick-actions slide-up" style="animation-delay:2.1s">
          <button class="quick-card glass" id="btn-achievements" aria-label="Достижения">
            <span class="quick-icon" aria-hidden="true">${c("achievements")}</span>
            <span class="quick-label">Достижения</span>
          </button>
          <button class="quick-card glass" id="btn-rating" aria-label="Рейтинг">
            <span class="quick-icon" aria-hidden="true">${c("rating")}</span>
      ...
      <section id="screen-shop" class="screen" role="main" aria-label="Лавка">
        ...
        <div class="glass shop-container">
          <div class="shop-empty">
            <div class="shop-soon-icon">${c("shop")}</div>
  ...
  `,s}function le(s,e,t,i){return`
    <section id="screen-${s}" class="screen screen--empty" role="main" aria-label="${t}">
      ...
      <div class="glass empty-content">
        <div class="empty-icon" aria-hidden="true">${c(s)}</div>
  ...
  `,document.body.appendChild(s),s}function ce(s,e=1600){setTimeout(()=>{s.style.transition="opacity 0.6s ease",s.style.opacity="0",setTimeout(()=>s.remove(),700)},e)}function de(){const s=document.getElementById("btn-achievements"),e=document.getElementById("btn-rating");[s,e].forEach(t=>{t&&t.addEventListener("click",()=>{n.haptic("light"),t.classList.remove("bounce"),t.offsetWidth,t.classList.add("bounce"),t.addEventListener("animationend",()=>t.classList.remove("bounce"),{once:!0})})})}function he(s){const e=document.getElementById("select-trophy-btn");e&&(e.addEventListener("click",s),e.addEventListener("pointerdown",()=>{e.style.transform="scale(0.96)"}),e.addEventListener("pointerup",()=>{e.style.transform=""}),e.addEventListener("pointerleave",()=>{e.style.transform=""}))}const F=[{id:"home",icon:"🧭",label:"ГЛАВНАЯ"},{id:"shop",icon:"🧺",label:"ЛАВКА"},{id:"friends",icon:"👤",label:"ДРУЗЬЯ"},{id:"guilds",icon:"🔱",label:"АРТЕЛИ"},{id:"book",icon:"📖",label:"КНИГА"}],k={name:"АКВАМАН_01",tag:"@aquaman01",level:15,xp:7200,maxXp:1e4,avatar:"🤿"},b={common:"#90e0ef",rare:"#00b4d8",legendary:"#f4a82e",aquarium:"#4cc9f0",mythical:"#ef476f",anomaly:"#7b2cbf"},pe=()=>{var s,e;return((e=(s=window.Telegram)==null?void 0:s.WebApp)==null?void 0:e.initData)||""};async function d(s,e={}){const i={"Content-Type":"application/json","X-Telegram-Init-Data":pe(),...e.headers||{}},a=await fetch(s,{...e,headers:i});if(!a.ok){const r=await a.json().catch(()=>({error:"Unknown error"}));throw new Error(r.error||`HTTP error! status: ${a.status}`)}return a.json()}class ue{constructor(){this.fillEl=null,this.wobbling=!1,this.profile={...k},this.el=this.build(),this.loadProfile()}async loadProfile(){try{const e=await d("/api/profile");e&&(this.profile.name=e.username||this.profile.name,this.profile.level=e.level||this.profile.level,this.profile.xp=e.xp||this.profile.xp,this.profile.maxXp=1e4,this.profile.tag=`@${e.user_id}`||this.profile.tag,this.updateUI())}catch(e){console.error("Failed to load profile:",e)}}updateUI(){const e=this.el.querySelector("#profile-name"),t=this.el.querySelector("#profile-tag"),i=this.el.querySelector(".level-label"),a=this.el.querySelector(".xp-label");e&&(e.textContent=this.profile.name.toUpperCase()),t&&(t.textContent=this.profile.tag),i&&(i.textContent=`Уровень ${this.profile.level}`),a&&(a.textContent=`${this.profile.xp.toLocaleString("ru")} XP`),this.animateProgress(0)}getElement(){return this.el}build(){const e=k,t=Math.round(e.xp/e.maxXp*100),i=document.createElement("div");i.id="profile-panel",i.className="profile-panel glass",i.innerHTML=`
    ...
    `,this.container.appendChild(e),setTimeout(()=>e.remove(),(a+.5)*1e3)}start(){this.intervalId=window.setInterval(()=>this.spawnOne(),380)}stop(){clearInterval(this.intervalId),this.container.querySelectorAll(".trophy-bubble").forEach(e=>e.remove())}restart(){this.stop(),this.start()}}const L=class L{static transitionTo(e,t){this.pendingTimeout&&(clearTimeout(this.pendingTimeout),this.pendingTimeout=0);const i=++this.transitionToken;e.style.transition="opacity 0.35s ease, transform 0.35s ease",e.style.opacity="0",e.style.transform="scale(0.93)",e.style.pointerEvents="none",t.style.transition="none",t.style.opacity="0",t.style.transform="scale(1.06)",t.style.display="flex",t.style.pointerEvents="none",this.pendingTimeout=window.setTimeout(()=>{i===this.transitionToken&&(e.style.display="none",e.style.opacity="",e.style.transform="",e.style.transition="",requestAnimationFrame(()=>{i===this.transitionToken&&(t.style.transition="opacity 0.38s cubic-bezier(0.25,0.46,0.45,0.94), transform 0.38s cubic-bezier(0.25,0.46,0.45,0.94)",t.style.opacity="1",t.style.transform="scale(1)",t.style.pointerEvents="all")}))},300)}};L.transitionToken=0,L.pendingTimeout=0;let $=L;const me={id:"no-trophy",emoji:"🐟",name:"Нет трофеев",latinName:"",rarity:"common",rarityLabel:"Обычная",rarityStars:"",weight:"0 кг",depth:"0 см"};class ge{constructor(e,t=2){this.cards=[],this.bubbleSpawner=null,this.fishData=[],this.startX=0,this.isDragging=!1,this.onChangeCallback=null,this.container=e,this.activeIndex=t,this.build(),this.bindSwipe(),this.update()}build(){this.container.innerHTML="",this.cards=[];const e=document.createElement("div");e.className="carousel__bubbles",this.container.appendChild(e),this.bubbleSpawner=new fe(e);const t=document.createElement("div");if(t.className="carousel__track",this.container.appendChild(t),this.fishData.length===0){t.innerHTML=`
        <div class="carousel__card is-active" style="opacity:1; transform:translateX(0) scale(1);">
          <div class="carousel__card-inner" style="--accent:${b.common}">
            <div class="carousel__fish-emoji">${c("trophy")}</div>
      ...
      `;return}this.fishData.forEach((i,a)=>{const r=document.createElement("div");r.className="carousel__card",r.dataset.index=String(a);const l=b[i.rarity];r.innerHTML=`
        <div class="carousel__card-inner" style="--accent:${l}">
          <div class="carousel__fish-emoji">${i.imageUrl?`<img src="${i.imageUrl}" alt="${i.name}" class="carousel__fish-image" loading="lazy">`:c(i.id)}</div>
      ...
      `,t.appendChild(r),this.cards.push(r)})}update(){var t;if(this.cards.length===0)return;this.cards.forEach((i,a)=>{const r=a-this.activeIndex,l=Math.abs(r);i.classList.remove("is-active","is-side","is-far");let o,h,m,g;switch(l){case 0:o=0,h=1,m=1,g=10,i.classList.add("is-active");break;case 1:o=r*148,h=.78,m=.6,g=5,i.classList.add("is-side");break;case 2:o=r*185,h=.62,m=.28,g=2,i.classList.add("is-far");break;default:o=r*200,h=.5,m=0,g=0}i.style.transform=`translateX(${o}px) scale(${h})`,i.style.opacity=String(m),i.style.zIndex=String(g)});const e=this.fishData[this.activeIndex];e&&((t=this.onChangeCallback)==null||t.call(this,e))}next(){this.fishData.length!==0&&this.activeIndex<this.fishData.length-1&&(this.activeIndex++,this.update(),n.haptic("light"))}prev(){this.fishData.length!==0&&this.activeIndex>0&&(this.activeIndex--,this.update(),n.haptic("light"))}goTo(e){this.fishData.length!==0&&(this.activeIndex=Math.max(0,Math.min(e,this.fishData.length-1)),this.update())}getActiveIndex(){return this.activeIndex}getActiveFish(){return this.fishData[this.activeIndex]||me}getItems(){return this.fishData}setFishData(e,t){if(this.fishData=[...e],t){const i=this.fishData.findIndex(a=>a.trophyId===t||a.id===t);this.activeIndex=i>=0?i:0}else this.activeIndex=this.fishData.length?Math.max(0,Math.min(this.activeIndex,this.fishData.length-1)):0;this.build(),this.update()}onChange(e){this.onChangeCallback=e}bindSwipe(){const e=this.container;e.addEventListener("touchstart",t=>{this.startX=t.touches[0].clientX,this.isDragging=!0},{passive:!0}),e.addEventListener("touchend",t=>{if(!this.isDragging)return;const i=t.changedTouches[0].clientX-this.startX;this.handleSwipeEnd(i),this.isDragging=!1},{passive:!0}),e.addEventListener("mousedown",t=>{this.startX=t.clientX,this.isDragging=!0,t.preventDefault()}),window.addEventListener("mouseup",t=>{if(!this.isDragging)return;const i=t.clientX-this.startX;this.handleSwipeEnd(i),this.isDragging=!1})}handleSwipeEnd(e){e<-42?this.next():e>42&&this.prev()}}const ye={обычная:"common",редкая:"rare",легендарная:"legendary",аквариумная:"aquarium",мифическая:"mythical",аномалия:"anomaly"},be={common:"Обычная",rare:"Редкая",legendary:"Легендарная",aquarium:"Аквариумная",mythical:"Мифическая",anomaly:"Аномалия"},we={common:"★★",rare:"★★★",legendary:"★★★★★",aquarium:"★★★★",mythical:"★★★★★",anomaly:"★★★★★★"},ke={common:"#90e0ef",rare:"#00b4d8",legendary:"#f4a82e",aquarium:"#4cc9f0",mythical:"#ef476f",anomaly:"#7b2cbf"};function v(s){const e=String(s||"").trim().toLowerCase();return ye[e]||"common"}function J(s){return be[v(s)]}function K(s){return we[v(s)]}function xe(s){return ke[v(s)]}let x=[],E="";function Ce(s){return`${(Number.isFinite(s)?Math.max(0,s):0).toLocaleString("ru-RU",{maximumFractionDigits:2})} кг`}function Me(s){return`${(Number.isFinite(s)?Math.max(0,s):0).toLocaleString("ru-RU",{maximumFractionDigits:1})} см`}function Le(s){const e=s.rarity||"Обычная";return{id:s.id,emoji:"🐟",name:s.fish_name||s.name||"Неизвестная рыба",latinName:"",rarity:v(e),rarityLabel:J(e),rarityStars:K(e),weight:Ce(Number(s.weight||0)),depth:Me(Number(s.length||0)),imageUrl:s.image_url||void 0,trophyId:s.id}}async function Se(){var s;try{const e=await d("/api/trophies"),t=Array.isArray(e==null?void 0:e.items)?e.items:[];return E=((s=t.find(i=>!!i.is_active))==null?void 0:s.id)||"",x=t.filter(i=>i.id!=="none").map(Le),x}catch(e){return console.error("Failed to load trophies:",e),x=[],E="",x}}async function $e(s){if(!s)return!1;try{const e=await d("/api/trophy/select",{method:"POST",body:JSON.stringify({trophy_id:s})});return!!(e!=null&&e.ok)}catch(e){return console.error("Failed to select trophy:",e),!1}}class Ee{constructor(){this.isOpen=!1,this.bgBlurTarget=null,this.onSelectCallback=null,this.currentActiveIndex=0,this.items=[],this.sheetStartY=0,this.sheetDragging=!1,this.overlay=this.buildOverlay(),this.sheet=this.overlay.querySelector("#modal-sheet"),this.listEl=this.overlay.querySelector("#modal-fish-list"),document.body.appendChild(this.overlay),this.bindClose()}buildOverlay(){const e=document.createElement("div");return e.id="modal-overlay",e.className="modal-overlay",e.innerHTML=`
    ...
    `,e}buildList(){if(this.items.length===0){this.listEl.innerHTML='<div class="modal-empty">У вас пока нет трофеев</div>';return}this.listEl.innerHTML=this.items.map((e,t)=>{const i=b[e.rarity],a=t===this.currentActiveIndex;return`
        <div
          ...
          aria-label="${e.name}"
        >
          <span class="modal-fish-emoji">${e.imageUrl?`<img src="${e.imageUrl}" alt="${e.name}" class="modal-fish-image" loading="lazy">`:c(e.id)}</span>
      ...
      `}).join(""),this.listEl.querySelectorAll(".modal-fish-item").forEach(e=>{e.addEventListener("click",()=>{const t=parseInt(e.dataset.index??"0",10);this.select(t)})})}open(e,t){this.isOpen||(this.currentActiveIndex=e,this.bgBlurTarget=t??null,this.buildList(),this.overlay.style.display="flex",requestAnimationFrame(()=>{this.overlay.classList.add("is-open"),this.bgBlurTarget&&(this.bgBlurTarget.style.filter="blur(4px)")}),this.isOpen=!0,n.haptic("medium"))}close(){this.isOpen&&(this.overlay.classList.remove("is-open"),this.bgBlurTarget&&(this.bgBlurTarget.style.filter=""),setTimeout(()=>{this.overlay.style.display="none"},420),this.isOpen=!1)}onSelect(e){this.onSelectCallback=e}setItems(e){this.items=[...e],this.currentActiveIndex=Math.max(0,Math.min(this.currentActiveIndex,this.items.length-1))}async select(e){var a;this.currentActiveIndex=e;const t=this.items[e],i=t!=null&&t.trophyId?await $e(t.trophyId):!0;if(n.haptic(i?"medium":"error"),!i){alert("Не удалось выбрать трофей. Попробуйте еще раз.");return}(a=this.onSelectCallback)==null||a.call(this,e),this.close()}bindClose(){this.overlay.addEventListener("click",t=>{t.target===this.overlay&&this.close()});const e=this.sheet;e.addEventListener("touchstart",t=>{this.sheetStartY=t.touches[0].clientY,this.sheetDragging=!0},{passive:!0}),e.addEventListener("touchmove",t=>{if(!this.sheetDragging)return;const i=t.touches[0].clientY-this.sheetStartY;i>0&&(e.style.transform=`translateY(${i*.55}px)`,e.style.transition="none")},{passive:!0}),e.addEventListener("touchend",t=>{if(!this.sheetDragging)return;const i=t.changedTouches[0].clientY-this.sheetStartY;e.style.transform="",e.style.transition="",i>80&&this.close(),this.sheetDragging=!1},{passive:!0})}get fish(){return this.items}}class qe{constructor(e,t){this.activeId="home",this.buttons=new Map,this.screens=new Map,this.onChangeCallbacks=[],this.el=this.build(),e.appendChild(this.el),F.forEach(i=>{const a=t.querySelector(`#screen-${i.id}`);a&&this.screens.set(i.id,a)}),this.screens.forEach((i,a)=>{a==="home"?(i.style.display="flex",i.style.opacity="1",i.style.pointerEvents="all"):(i.style.display="none",i.style.opacity="0")})}build(){const e=document.createElement("nav");return e.id="tab-bar",e.className="tab-bar",e.setAttribute("role","tablist"),F.forEach(t=>{const i=document.createElement("button");i.id=`tab-${t.id}`,i.className=`tab-btn ${t.id==="home"?"is-active":""}`,i.setAttribute("role","tab"),i.setAttribute("aria-selected",t.id==="home"?"true":"false"),i.dataset.tab=t.id,i.innerHTML=`
        <span class="tab-icon" aria-hidden="true">${c(t.id)}</span>
        <span class="tab-label">${t.label}</span>
      `,i.addEventListener("click",()=>this.switchTo(t.id)),i.addEventListener("pointerdown",()=>{i.style.transform="scale(0.92)"}),i.addEventListener("pointerup",()=>{i.style.transform=""}),i.addEventListener("pointerleave",()=>{i.style.transform=""}),e.appendChild(i),this.buttons.set(t.id,i)}),e}switchTo(e){if(e===this.activeId)return;n.haptic("selection");const t=this.activeId,i=this.screens.get(t),a=this.screens.get(e);!i||!a||($.transitionTo(i,a),this.buttons.forEach((r,l)=>{const o=l===e;r.classList.toggle("is-active",o),r.setAttribute("aria-selected",String(o))}),this.activeId=e,this.onChangeCallbacks.forEach(r=>r(t,e)))}onChange(e){this.onChangeCallbacks.push(e)}getActive(){return this.activeId}}let q=[],Q=0;async function ee(){try{const s=await d("/api/book?limit=500");s&&s.ok&&(Q=Number(s.total_all||0),q=s.items.map(e=>({id:e.image_file||"fishdef",emoji:"🐟",name:e.name,latinName:e.name,rarity:Ie(e.rarity),glowColor:Te(e.rarity),depth:`${e.min_weight}-${e.max_weight} кг`,habitat:e.locations,length:`${e.min_length}-${e.max_length} см`,description:e.lore||`Рыба вида ${e.name}.`,funFact:e.baits?`Лучше ловится на: ${e.baits}.`:"Информации пока нет.",chapter:"Общий атлас",isCaught:e.is_caught,imageUrl:e.image_url||void 0})))}catch(s){console.error("Failed to load encyclopedia:",s)}}function Ie(s){return v(s)}function Te(s){return xe(s)}const _e={common:"★★ Обычная",rare:"★★★ Редкая",legendary:"★★★★★ Легендарная",aquarium:"★★★★ Аквариумная",mythical:"★★★★★ Мифическая",anomaly:"★★★★★★ Аномалия"};class Ae{constructor(){this.entries=[],this.filtered=[],this.index=0,this.loading=!1,this.pageFlip=null,this.el=this.buildShell()}getElement(){return this.el}buildShell(){const e=document.createElement("section");return e.id="screen-book",e.className="screen book-screen",e.setAttribute("role","main"),e.innerHTML=`
        ...
        <div class="ph-content parchment">
          ...
          <div class="ph-fish-block">
            <div class="ph-fish-emoji" style="--glow: ${t?e.glowColor:"#555"}; filter: ${t?"none":"grayscale(100%) contrast(50%) brightness(70%)"}">
              ${e.imageUrl?`<img src="${e.imageUrl}" alt="${e.name}" class="ph-fish-image" loading="lazy">`:c(e.id)}
            </div>
          </div>
          ...
          <div class="ph-rarity-wrap">
            <div class="ph-rarity" style="color:${t?e.glowColor:"#777"}; border-color:${t?e.glowColor:"#777"}55">
              ${t?_e[e.rarity]:'<span style="color: #ff4d4d; font-weight: bold;">НЕ СЛОВЛЕНА</span>'}
            </div>
          </div>
    ...
    `,e}async init(){await this.loadInventory(),this.bindEvents()}bindEvents(){const e=this.el.querySelectorAll(".shop-tab-btn");e.forEach(t=>{t.addEventListener("click",()=>{if(t.classList.contains("is-active"))return;n.haptic("light"),e.forEach(a=>a.classList.remove("is-active")),t.classList.add("is-active"),t.dataset.tab==="inventory"?this.renderInventory():this.renderMarketSoon()})})}async loadInventory(){this.loading=!0;try{const e=await d("/api/inventory");this.items=(e==null?void 0:e.items)||[],this.renderInventory()}catch(e){console.error("Failed to load inventory:",e),this.renderError()}finally{this.loading=!1}}renderInventory(){const e=this.el.querySelector("#shop-content");if(this.items.length===0){e.innerHTML=`
        <div class="shop-empty">
          <div class="shop-soon-icon">${c("shop")}</div>
          <h3>Садок пуст</h3>
      ...
      <div class="inventory-list">
        ${this.items.map(t=>{const i=v(t.rarity),a=b[i];return`
            <div class="inventory-item glass" style="--accent: ${a}">
              <div class="inv-item-img">
                <img src="${t.image_url}" alt="${t.name}" loading="lazy">
              </div>
              <div class="inv-item-info">
                <div class="inv-item-name">${t.name}</div>
                <div class="inv-item-rarity" style="color: ${a}">${K(t.rarity)} ${J(t.rarity)}</div>
                <div class="inv-item-stats">
                  <span>⚖️ ${t.weight.toFixed(2)} кг</span>
                  <span>📏 ${t.length.toFixed(1)} см</span>
                </div>
              </div>
    ...
    `}renderMarketSoon(){const e=this.el.querySelector("#shop-content");e.innerHTML=`
      <div class="shop-empty">
        <div class="shop-soon-icon">${c("shop")}</div>
        <h3>Рынок скоро откроется!</h3>
        <p>Здесь вы сможете покупать снаряжение, наживку и другие полезные вещи.</p>
      </div>
    `}renderError(){const e=this.el.querySelector("#shop-content");e.innerHTML=`
      <div class="shop-empty">
        <div class="shop-soon-icon">❌</div>
        <h3>Ошибка загрузки</h3>
        <p>Не удалось загрузить инвентарь. Попробуйте позже.</p>
      </div>
    `}}const P=["guild_beer","guild_rich","guild_cthulhu","guild_king"],N=["#00b4d8","#f4a82e","#9b5de5","#ff6b6b","#a5a5a5","#4d908e"];let p=[],u=null,_=!1;async function w(){try{const s=await d("/api/guilds");if(s&&s.ok){const e=s.my_clan;if(e&&e.id){const t=Array.isArray(e.requests)?e.requests:[],i={id:String(e.id),name:e.name,avatar:e.avatar_emoji||"🔱",borderColor:e.color_hex||"#00b4d8",type:e.access_type||"open",level:e.level||1,members:[],requests:t.map(a=>({requestId:String(a.request_id??a.id??""),userId:String(a.user_id??a.requester_user_id??""),name:String(a.username||"user"),level:Number(a.level||0),userAvatar:String(a.user_avatar||"👤")})),upgradeProgress:[],capacity:20,minLevel:e.min_level||0};p=[i],u=i.id,_=e.role==="leader"}else p=(s.items||[]).map(t=>({id:String(t.id),name:t.name,avatar:t.avatar_emoji||"🔱",borderColor:t.color_hex||"#00b4d8",type:t.access_type||"open",level:t.level||1,members:[],requests:[],upgradeProgress:[],capacity:20,minLevel:t.min_level||0})),u=null}}catch(s){console.error("Failed to load clans:",s)}}async function He(s){try{const e=await d("/api/guilds/create",{method:"POST",body:JSON.stringify({name:s.name,avatar:s.avatar,color:s.borderColor,type:s.type,min_level:s.minLevel})});if(e&&e.ok)return await w(),p.find(t=>t.id===String(e.clan_id))||null;e&&!e.ok&&(e.reason==="not_enough_coins"?alert(`Недостаточно монет для создания артели! Нужно ${e.cost.toLocaleString()} 🪙`):alert(`Ошибка создания: ${e.reason||"неизвестная ошибка"}`))}catch(e){console.error("Failed to create guild:",e)}return null}async function Fe(s){const e=p.find(t=>t.id===s);if(!e)return!1;try{const t=e.type==="open"?"/api/guilds/join":"/api/guilds/apply",i=await d(t,{method:"POST",body:JSON.stringify({guild_id:s})});if(i&&i.ok)return e.type==="open"&&(u=e.id),!0;i&&!i.ok&&(i.reason==="level_too_low"?alert(`Ваш уровень слишком низок! Требуется уровень ${i.required}`):i.reason==="not_enough_coins"?alert(`Недостаточно монет! Требуется ${i.cost} 🪙`):alert(`Ошибка: ${i.reason||i.error||"неизвестная ошибка"}`))}catch(t){console.error("Failed to join guild:",t)}return!1}async function O(s,e){try{const t=await d("/api/guilds/request/respond",{method:"POST",body:JSON.stringify({request_id:s,action:e})});if(t&&t.ok)return await w(),!0;t&&!t.ok&&alert(`Ошибка обработки заявки: ${t.error||"неизвестная ошибка"}`)}catch(t){console.error("Failed to respond to clan request:",t)}return!1}async function Pe(){if(u)try{const s=await d("/api/guilds/leave",{method:"POST"});s&&s.ok&&(u=null,_=!1,await w())}catch(s){console.error("Failed to leave guild:",s)}}class Ne{constructor(){this.view="list",this.loading=!1,this.newGuildName="",this.selectedAvatar=P[0],this.selectedColor=N[0],this.selectedType="open",this.selectedMinLevel=0,this.el=this.buildShell()}getElement(){return this.el}buildShell(){const e=document.createElement("section");return e.id="screen-guilds",e.className="screen guilds-screen",e.setAttribute("role","main"),e}async init(){this.loading=!0,this.render(),await w(),this.loading=!1,this.render()}render(){if(this.loading){this.el.innerHTML='<div style="display:flex; justify-content:center; align-items:center; height:100%; color:white;">Загрузка...</div>';return}u?this.renderManage():this.view==="create"?this.renderCreate():this.renderList()}renderList(){var e;this.el.innerHTML=`
      ...
      <div class="guild-list">
        ${p.map(t=>`
          <div class="guild-card glass" data-id="${t.id}">
            <div class="guild-avatar" style="--border-color: ${t.borderColor}">${c(t.avatar)}</div>
    ...
    `,(e=this.el.querySelector("#guild-create-trigger"))==null||e.addEventListener("click",()=>{this.view="create",this.render(),n.haptic("medium")}),this.el.querySelectorAll(".guild-card").forEach(t=>{var i;(i=t.querySelector("button"))==null||i.addEventListener("click",async a=>{a.stopPropagation();const r=t.getAttribute("data-id");if(await Fe(r)){n.haptic("heavy");const o=p.find(h=>h.id===r);(o==null?void 0:o.type)==="invite"?alert("Заявка отправлена!"):await this.init()}else n.haptic("error"),alert("Не удалось вступить в артель.")})})}renderCreate(){var i,a;this.el.innerHTML=`
      ...
      <div class="glass artel-form" style="padding: 20px;">
        ...
        <div class="form-group">
          ...
          <div class="avatar-grid">
            ${P.map(r=>`
              <div class="avatar-opt ${this.selectedAvatar===r?"is-selected":""}" data-val="${r}">${c(r)}</div>
            `).join("")}
          </div>
        </div>
    ...
    `;const e=this.el.querySelector("#guild-name-input");e.addEventListener("input",()=>{this.newGuildName=e.value}),this.el.querySelectorAll(".avatar-opt").forEach(r=>{r.addEventListener("click",()=>{this.selectedAvatar=r.getAttribute("data-val"),this.render()})}),this.el.querySelectorAll(".color-opt").forEach(r=>{r.addEventListener("click",()=>{this.selectedColor=r.getAttribute("data-val"),this.render()})}),this.el.querySelectorAll(".type-opt").forEach(r=>{r.addEventListener("click",()=>{this.selectedType=r.getAttribute("data-val"),this.render()})});const t=this.el.querySelector("#min-level-slider");t&&t.addEventListener("input",()=>{this.selectedMinLevel=parseInt(t.value);const r=this.el.querySelector("#min-level-label");r&&(r.textContent=`Минимальный уровень: ${this.selectedMinLevel}`)}),(i=this.el.querySelector("#create-cancel"))==null||i.addEventListener("click",()=>{this.view="list",this.render()}),(a=this.el.querySelector("#create-confirm"))==null||a.addEventListener("click",async()=>{if(this.newGuildName.trim().length<3){alert("Слишком короткое название!");return}await He({name:this.newGuildName,avatar:this.selectedAvatar,borderColor:this.selectedColor,type:this.selectedType,minLevel:this.selectedMinLevel})?(n.haptic("heavy"),await this.init()):(n.haptic("error"),alert("Ошибка при создании артели."))})}renderManage(){var i;const e=p.find(a=>a.id===u),t=_;this.el.innerHTML=`
      ...
      <div class="glass" style="padding: 12px; display:flex; align-items:center; gap:12px; margin-bottom:12px;">
         <div class="guild-avatar" style="width:64px; height:64px; font-size:32px; --border-color:${e.borderColor}">${c(e.avatar)}</div>
         <div class="guild-info">
    ...
    `,(i=this.el.querySelector("#btn-leave"))==null||i.addEventListener("click",()=>{confirm("Вы уверены, что хотите покинуть артель?")&&(Pe(),n.haptic("medium"),this.render())}),this.el.querySelectorAll(".donate-btn").forEach(a=>{a.addEventListener("click",()=>{const r=parseInt(a.getAttribute("data-idx"),10),l=e.upgradeProgress[r];l.current=Math.min(l.required,l.current+Math.floor(Math.random()*5)+1),n.haptic("selection"),this.render()})}),this.el.querySelectorAll(".req-btn--yes").forEach(a=>{a.addEventListener("click",async()=>{const r=a.getAttribute("data-id");if(!r)return;const l=await O(r,"accept");n.haptic(l?"heavy":"error"),l&&await this.init()})}),this.el.querySelectorAll(".req-btn--no").forEach(a=>{a.addEventListener("click",async()=>{const r=a.getAttribute("data-id");if(!r)return;const l=await O(r,"decline");n.haptic(l?"medium":"error"),l&&await this.init()})})}}let I=[],y=[];async function C(){try{const s=await d("/api/friends");if(s&&s.ok){const e=Array.isArray(s.items)?s.items:[],t=Array.isArray(s.incoming_requests)?s.incoming_requests:[];I=e.map(i=>({id:String(i.user_id),name:i.username,level:Number(i.level||0),avatar:"👤",online:!!i.is_online,xp:Number(i.xp||0)})),y=t.map(i=>({id:String(i.request_id||i.id),name:String(i.username||"user"),level:Number(i.level||0),avatar:"👤"}))}}catch(s){console.error("Failed to load friends:",s)}}async function Oe(s){try{const e=await d("/api/friends/add",{method:"POST",body:JSON.stringify({username:s})});return!!(e!=null&&e.ok)}catch(e){return console.error("Failed to send friend request:",e),!1}}async function De(s){return te(s,"accept")}async function Ve(s){return te(s,"decline")}async function te(s,e){try{const t=await d("/api/friends/request/respond",{method:"POST",body:JSON.stringify({request_id:s,action:e})});if(t!=null&&t.ok)return await C(),!0}catch(t){console.error("Failed to respond friend request:",t)}return!1}class ze{constructor(){this.currentView="list",this.loading=!1,this.el=this.buildShell()}getElement(){return this.el}buildShell(){const e=document.createElement("section");return e.id="screen-friends",e.className="screen friends-screen",e.setAttribute("role","main"),e}async init(){this.loading=!0,this.render(),await C(),this.loading=!1,this.render()}render(){if(this.loading){this.el.innerHTML='<div style="display:flex; justify-content:center; align-items:center; height:100%; color:white;">Загрузка...</div>';return}this.currentView==="requests"?this.renderRequests():this.renderList()}renderList(){var e,t;this.el.innerHTML=`
      ...
      <div class="friends-list" style="margin-top: 20px; display:flex; flex-direction:column; gap:10px;">
        ${I.length===0?'<p style="text-align:center; opacity:0.5; font-size:12px; margin-top:20px;">У вас пока нет друзей</p>':""}
        ${I.map(i=>`
    ...
    `,(e=this.el.querySelector("#btn-show-requests"))==null||e.addEventListener("click",()=>{this.currentView="requests",this.render(),n.haptic("medium")}),(t=this.el.querySelector("#btn-add-search"))==null||t.addEventListener("click",async()=>{const i=this.el.querySelector("#friend-search");i.value.trim()&&(await Oe(i.value.trim())?(alert("Запрос отправлен!"),i.value="",n.haptic("light"),await C(),this.render()):(n.haptic("error"),alert("Не удалось отправить заявку.")))})}renderRequests(){var e;this.el.innerHTML=`
      <div class="friends-header-row">
    ...
    `,(e=this.el.querySelector("#btn-back-list"))==null||e.addEventListener("click",()=>{this.currentView="list",this.render(),n.haptic("light")}),this.el.querySelectorAll(".req-btn--yes").forEach(t=>{t.addEventListener("click",async()=>{const i=t.getAttribute("data-id"),a=await De(i);n.haptic(a?"heavy":"error"),this.render()})}),this.el.querySelectorAll(".req-btn--no").forEach(t=>{t.addEventListener("click",async()=>{const i=t.getAttribute("data-id"),a=await Ve(i);n.haptic(a?"medium":"error"),this.render()})})}}class Re{constructor(e){this.particles=[],this.W=0,this.H=0,this.rafId=0,this.COUNT=60,this.canvas=e,this.ctx=e.getContext("2d"),this.resize(),window.addEventListener("resize",this.resize.bind(this));for(let t=0;t<this.COUNT;t++){const i=this.createParticle();i.y=Math.random()*this.H,i.life=Math.floor(Math.random()*i.maxLife*.5),this.particles.push(i)}this.loop()}resize(){this.W=this.canvas.width=this.canvas.offsetWidth,this.H=this.canvas.height=this.canvas.offsetHeight}createParticle(){const e=Math.random()<.28;return{x:Math.random()*this.W,y:this.H+12,r:e?1.5+Math.random()*2:1.2+Math.random()*3,vx:(Math.random()-.5)*.4,vy:-(.2+Math.random()*.55),alpha:0,alphaTarget:.12+Math.random()*.4,life:0,maxLife:180+Math.random()*420,isSediment:e,wobble:Math.random()*Math.PI*2,wobbleSpeed:.02+Math.random()*.03}}drawBubble(e){const t=this.ctx;e.wobble+=e.wobbleSpeed;const i=e.x+Math.sin(e.wobble)*1.8;t.save(),t.globalAlpha=e.alpha,t.strokeStyle="rgba(160,220,255,0.65)",t.lineWidth=.7,t.beginPath(),t.arc(i,e.y,e.r,0,Math.PI*2),t.stroke(),t.fillStyle="rgba(255,255,255,0.35)",t.beginPath(),t.arc(i-e.r*.28,e.y-e.r*.28,e.r*.38,0,Math.PI*2),t.fill(),t.restore()}drawSediment(e){const t=this.ctx;t.save(),t.globalAlpha=e.alpha,t.fillStyle="rgba(180,150,90,0.7)",t.beginPath(),t.ellipse(e.x,e.y,e.r*1.6,e.r*.55,e.wobble,0,Math.PI*2),t.fill(),t.restore()}updateParticle(e){e.x+=e.vx,e.y+=e.vy,e.life+=1;const t=40,i=50;return e.life<t?e.alpha=e.life/t*e.alphaTarget:e.life>e.maxLife-i?e.alpha=(e.maxLife-e.life)/i*e.alphaTarget:e.alpha=e.alphaTarget,e.life<e.maxLife&&e.y>-10}loop(){this.ctx.clearRect(0,0,this.W,this.H);for(let e=0;e<this.particles.length;e++){const t=this.particles[e];this.updateParticle(t)?t.isSediment?this.drawSediment(t):this.drawBubble(t):this.particles[e]=this.createParticle()}this.rafId=requestAnimationFrame(this.loop.bind(this))}destroy(){cancelAnimationFrame(this.rafId),window.removeEventListener("resize",this.resize.bind(this))}}const je=oe();ne();const Ue=document.getElementById("particles-canvas");new Re(Ue);const Xe=document.getElementById("bg-parallax");new ve(Xe);const A=new ue;A.updateFromTelegram();const Ye=document.getElementById("profile-mount");Ye.appendChild(A.getElement());async function Ge(){try{await Promise.all([C(),w(),ee()]),console.log("Initial data loaded")}catch(s){console.error("Failed to load initial data:",s)}}Ge();const We=document.getElementById("carousel-mount"),M=new ge(We,2),f=document.getElementById("screens-wrap"),B=new Ee;async function Ze(){const s=await Se();M.setFishData(s,E),B.setItems(M.getItems())}Ze();B.onSelect(s=>{M.goTo(s)});he(()=>{B.open(M.getActiveIndex(),f)});const ie=new Ae,D=ie.getElement(),V=document.getElementById("screen-book");V?V.replaceWith(D):f.appendChild(D);const se=new Be,z=se.getElement(),R=document.getElementById("screen-shop");R?R.replaceWith(z):f.appendChild(z);const ae=new Ne,j=ae.getElement(),U=document.getElementById("screen-guilds");U?U.replaceWith(j):f.appendChild(j);const T=new ze,X=T.getElement(),Y=document.getElementById("screen-friends");Y?Y.replaceWith(X):f.appendChild(X);let G=!1,W=!1,Z=!1,S=!1;const Je=document.getElementById("tabbar-mount"),Ke=new qe(Je,f);Ke.onChange((s,e)=>{e==="book"&&!G&&(ie.init(),G=!0),e==="shop"&&!W&&(se.init(),W=!0),e==="guilds"&&!Z&&(ae.init(),Z=!0),e==="friends"&&!S?(T.init(),S=!0):e==="friends"&&S&&T.init()});de();setTimeout(()=>A.animateProgress(0),2e3);ce(je,1600);
